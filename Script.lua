...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/siria1eljoker1/siriafiles/main/GetVersion.txt' ) or 0
...
{{text = '- 𓆩 ＳＯＵＲＳＥ ＳＩＲＩＡ †࿃ 𓆪 .',url="https://t.me/SOURCE_SYRIA"}},
}   
...
if siria == 'welcome on' or siria == 'تفعيل سوريا تيم' then
if redis:get(siria..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل سوريا تيم سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل سوريا تيم')
redis:set(siria..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تيم البلاك' then
if redis:get(siria..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم سورياسابقا')
redis:set(siria..'welc'..msg.chat_id_,'off')
redis:del(siria..'welc'..msg.chat_id_,'on')
else
...
{"تفعيل سوريا تيم","تعطيل تيم البلاك"},
...
elseif Text== "سوريا" or Text== "سوريا" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمـد من القـمدان ياروحي](https://t.me/SIRIA199)")
elseif Text== "عرابي" or Text== "عرابي" then return  sendMsg(msg.chat_id_,msg.id_,"[البابا عرابي ↯](https://t.me/DEV_ORABI)")
elseif Text== "سورس سوريا" or Text== "سورس" then return  sendMsg(msg.chat_id_,msg.id_,"[احسن سورس مصري ↯](https://t.me/SOURCE_SYRIA)")
