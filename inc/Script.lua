...
return ' ༺ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(siria..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[ ༺ اهلا انا بوت]]..redis:get(siria..':NameBot:')..[[ .
...
return' ༺ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(siria..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return " ༺ **هذا الامر يخص {المطور} فقط  \n" end
return ' ༺ ** عدد المجموعات المفعلة » `'..redis:scard(siria..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return " ༺ **هذا الامر يخص {المطور} فقط  \n" end
return ' ༺ **عدد المشتركين في البوت : `'..redis:scard(siria..'users')..'` \n'
end
...
return redis:get(siria..":TEXT_SUDO") or ' ༺ لا توجد كليشه المطور .\n ༺ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="ااذاعه بالتثبيت ♥" then
if not msg.SudoUser then return" ༺ **هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(siria..'lock_brod') then return " ༺ ** الاذاعه مقفوله من قبل المطور الاساسي ." end
...
return ' ༺ اصدار سورس سوريا : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,' ༺ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سوريا يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="𓆩 اقـــمــــد مــن الـــقــمــدان يـــآروحـــي 𓆪 ",url="https://t.me/siria22"}}}
send_key(msg.sender_user_id_,'   [مبرمج السورس سوريا](https://t.me/siria22)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return" ༺ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return ' ༺ الاحصائيات . \n\n ༺ **عدد المجموعات المفعله : '..redis:scard(siria..'group:ids')..'\n ༺ **عدد المشتركين في البوت : '..redis:scard(siria..'users')..'\n'
end
---------------[End Function data] -----------------------
...
local keyboard = {}
keyboard.inline_keyboard = {
{{text = '𖤛𝖕𝖗𝖔𝖌𝖗𝖆𝖒𝖒𝖊𝖗 𝖘𝖞𝖗𝖎𝖆𖤛“ .',url="https://t.me/siria22"}},
{{text = '𖤛𝖉𝖊𝖛 𝖔𝖗𝖆𝖕𝖎𖤛 .',url="https://t.me/DEV_ORABI"}},
{{text = '𖤛𝖆𝖇𝖓 𝖆𝖑𝖘𝖆𝖍𝖊𝖑 𖤛 .',url="https://t.me/ABN_ALSAHL2"}},
{{text = '𖤛𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𖤛℡ .',url="https://t.me/SOURCE_SYRIA"}},
{{text = '- اضــف البوت الـي مـجـمـوعـتـك .',url="https://t.me/SY_RI_Abot?startgroup=start"}},
}  
send_inline(msg.chat_id_,  "𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚈𝚁𝙸𝙰, 𝚃𝙷𝙴 𝙼𝙾𝚂𝚃 𝙿𝙾𝚆𝙴𝚁𝙵𝚄𝙻 𝚂𝙴𝙲𝚄𝚁𝙸𝚃𝚈 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 ཻ ☫“" ,keyboard,'html')
end
...
return ' ༺ **عدد سحكاتك ⇜ ❪ '..(redis:get(siria..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
text = [[ ༺ أهلاً انا بوت   []]..redis:get(siria..':NameBot:')..[[] 🗽
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(siria..':WELCOME_BOT'),[[ ༺أهلاً انا بوت ]]..redis:get(siria..':NameBot:')..[[
 ༺ أختصاصي حماية‌‏ المجموعات
 ༺ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(siria..'welcome:msg'..msg.chat_id_) or " ༺ اهلاً عزيزي {الاسم}\n ༺ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n ༺ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(siria..'rulse:msg'..msg.chat_id_) or " ༺ مرحباً عزيري القوانين كلاتي .\n ༺ ممنوع نشر الروابط\n ༺ ممنوع التكلم او نشر صور اباحيه\n ༺ ممنوع  اعاده توجيه\n ༺ ممنوع التكلم بالسياسة\n ༺ الرجاء احترام المدراء والادمنيه .\n")
...
welcome = (redis:get(siria..'welcome:msg'..msg.chat_id_) or " ༺ اهلن بك عزيزي {الاسم}\n ༺ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n ༺ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(siria..'rulse:msg'..msg.chat_id_) or " ༺ مرحباً عزيري القوانين كلاتي .\n ༺ ممنوع نشر الروابط\n ༺ ممنوع التكلم او نشر صور اباحيه\n ༺ ممنوع  اعاده توجيه\n ༺ ممنوع التكلم بالسياسة\n ༺ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
SendMention(msg.chat_id_,datau.id_,msg.id_," ༺ العضو » "..USERNAME.."\n ༺ قمـت بتكرار اكثر مـن "..NUM_MSG_siria.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
...
elseif Text== "ابن الساحل" then return  sendMsg(msg.chat_id_,msg.id_,"[اقـمــد مـن القـمـدان يــروحـي ](https://t.me/ABN_ALSAHL2)")
elseif Text== "سوريا" then return  sendMsg(msg.chat_id_,msg.id_,"[اقـمــد مـن القـمـدان يــروحـي ](https://t.me/siria22)")
elseif Text== "عرابي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/DEV_ORABI)")
...
elseif Text== "رفع السوريا"  then return sendMsg(msg.chat_id_,msg.id_," ༺ آههلآ  عـزيزي\n ༺ لقد تم رفع سوريا بنجاح \n ༺ اديلو سوريا\n")
elseif Text== "تنزيل السوريا"  then return sendMsg(msg.chat_id_,msg.id_," ༺ آههلآ  عـزيزي\n ༺ لقد تم رفع سوريا بنجاح \n ༺ اديلو سوريا\n")
...
elseif Text== "رفع سوريا"  then return sendMsg(msg.chat_id_,msg.id_," ༺ آههلآ  عـزيزي\n ༺ تم رفع الواد ضمن الزنوج بنجاح\n ༺الان هو في قائمه القوقازيه \n")
elseif Text== "تنزيل سوريا"  then return sendMsg(msg.chat_id_,msg.id_," ༺ آههلآ  عـزيزي\n ༺ تم ازاله الواد بعيدا عن الزنوج بنجاح \n ༺الان تم ازلته من قائمه الزنوج\n")
...
☆
╰──── ● ☆ ● ────╯
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼  ༺━━≫/n ༺ مرحباً عزيزي\n ༺ هذي اوامر التسليه:  \n┄─┅═ـ═┅─┄\n ༺ رفع ≪━≫ تنزيل ❬ متوحد ❭\n ༺ رفع ≪━≫ تنزيل ❬ وتكه ❭\n ༺ رفع ≪━≫ تنزيل ❬ غبي ❭\n ༺ رفع ≪━≫ تنزيل ❬ كلب ❭\n ༺ رفع ≪━≫ تنزيل ❬ حمار ❭\n ༺ رفع ≪━≫ تنزيل ❬ زوجتي ❭\n ༺ رفع ≪━≫ تنزيل ❬ متوحده ❭\n ༺ رفع ≪━≫ ❬ بقلبي ❭ تنزيل ≪━≫ ❬ من قلبي❭\n ༺ ❬ طلاق ❭ ≪━≫ ❬ زواج ❭\n┄─┅═ـ═┅─┄")
...
if not redis:get('kar') then
  ...
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,' ༺ انتهى الاشتراك في احد المجموعات .\n ༺ المجموعه : '..FlterName(redis:get(siria..'group:name'..msg.chat_id_))..'.\n ༺ ايدي : '..msg.chat_id_)
