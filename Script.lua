...
return "𖤓 *│* هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n"
end
redis:set(siria.."getidstatus"..msg.chat_id_, "Simple")
return  "𖤓 ** أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** تم تعطيل الايدي بالصوره  \n" 
end 
function unlock_photos(msg)
if not msg.Director then
return "𖤓 ** هذا الامر يخص {المدير,المنشئ,المطور} فقط  \n"
end
redis:set(siria.."getidstatus"..msg.chat_id_, "Photo")
return  "𖤓 ** أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** تم تفعيل الايدي بالصوره \n" 
end
function cmds_on(msg)
if not msg.Creator then return "𖤓 ** هذا الامر يخص {المنشئ,المطور} فقط  \n"
end
redis:set(siria..'lock:kara:'..msg.chat_id_,'on')
return "𖤓 ** أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** تم تعطيل الرفع في المجموعه \n"
end
function cmds_off(msg)
if not msg.Creator then return "𖤓 ** هذا الامر يخص {المنشئ,المطور} فقط  \n"
end
redis:set(siria..'lock:kara:'..msg.chat_id_,'off')
return "𖤓 ** أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** تم تفعيل الرفع في المجموعه \n"
end

function lockjoin(msg)
if not msg.Admin then return "𖤓 *│* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n"
end
redis:set(siria..'lock:join:'..msg.chat_id_,true)
return "*𖤓 ** أهلا عزيزي *"..msg.TheRankCmd.."*\n𖤓 ** تم قفل الدخول بالرابط \n*" 

end
function unlockjoin(msg)
if not msg.Admin then return "𖤓 ** هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n"
end
redis:del(siria..'lock:join:'..msg.chat_id_)
return "*𖤓 ** أهلا عزيزي *"..msg.TheRankCmd.."*\n𖤓 ** تم فتح الدخول بالرابط \n*" 
end


local function isiria(msg,MsgText)

Channel = redis:get(siria..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(siria..'joinchnl') then
...
bd = '𖤓 اسمك  ('..(data.first_name_ or '')..')\n𖤓 معرفك (@'..(data.username_ or '')..')\n\n𖤓 اشترك بالقناه اولا \n𖤓 ثم ارجع استخدم الامر.'
local keyboard = {}
...
redis:setex(siria..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(siria..'CheckExpire::'..msg.chat_id_) then 
redis:set(siria..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(siria..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(siria..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(siria..'CheckExpire::'..msg.chat_id_) then 
redis:set(siria..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(siria..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(siria..'CheckExpire::'..msg.chat_id_) then 
redis:set(siria..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(siria..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(siria..'CheckExpire::'..msg.chat_id_) then 
redis:set(siria..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(siria..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(siria..'group:name'..msg.chat_id_) or '')
redis:set(siria..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
return sendMsg(msg.chat_id_,msg.id_,
"𖤓 ❪ مـعـلومـات الـمـجـموعـه ❫\n\n"
.."*𖤓 * عدد الأعضاء ⇜ ❪ *"..data.member_count_.."* ❫"
.."\n*𖤓 * عدد المحظورين ⇜ ❪ *"..data.kicked_count_.."* ❫"
.."\n*𖤓 * عدد المشرفين ⇜ ❪ *"..data.administrator_count_.."* ❫"
.."\n*𖤓 * ايدي المجموعه ⇜ ❪"..msg.chat_id_.."❫"
.."\n\n𖤓 اسم المجموعه ⇜ ❪  ["..FlterName(GroupName).."]("..(data.invite_link_ or "")..")  ❫\n"
)
end,nil) 
return false
end
...
users = redis:get(siria..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 المعرف غير صحيح \n')   
end   
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 هاذا معرف قناة \n')   
end      
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. siria..'')
...
return sendMsg(msg.chat_id_,msg.id_,'\n𖤓 ًاهلا عزيزي البوت هنا ادمن بالقروب \n𖤓 وصلاحياته هي ↓ \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n𖤓 تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n𖤓 حذف الرسائل ↞ ❪ '..delete..' ❫\n𖤓 حظر المستخدمين ↞ ❪ '..restrict..' ❫\n𖤓 دعوة مستخدمين ↞ ❪ '..invite..' ❫\n𖤓 تثبيت الرسائل ↞ ❪ '..pin..' ❫\n𖤓 اضافة مشرفين جدد ↞ ❪ '..promote..' ❫\n\n𖤓 ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end
...
if not msg.Director and redis:get(siria..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(siria..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
return sendMsg(msg.chat_id_,msg.id_,"𖤓 **ً أهلا عزيزي "..msg.TheRankCmd.." \n𖤓 ** تم تثبيت الرساله \n𖤓")
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** ًعذرا لا يمكنني التثبيت .\n𖤓 ** لست مشرف او لا املك صلاحيه التثبيت \n')    
end
end,nil)
end
return false
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"𖤓 **ًأهلا عزيزي "..msg.TheRankCmd.."  \n𖤓 ** تم الغاء تثبيت الرساله \n")    
elseif data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 **𖤓 عذراً لا يمكنني الغاء التثبيت .\n𖤓 ** لست مشرف او لا املك صلاحيه التثبيت \n')    
elseif data.ID == "Error" and data.code_ == 400 then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** ًعذرا عزيزي '..msg.TheRankCmd..' .\n𖤓 ** لا توجد رساله مثبته لاقوم بازالتها \n')    
end
end,nil)
end
return false
...
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(siria..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(siria..'lock:kara:'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,"𖤓 ** أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** الرفع معطل \n")
end
return false
end
...
if not msg.Creator then return "𖤓 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(siria..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(siria..'lock:kara:'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,"𖤓 ** أهلاً عزيزي "..msg.TheRankCmd.."\n𖤓 ** الرفع معطل \n")
end
return false
end
...
if not msg.SudoUser then return "𖤓 **هذا الامر يخص {المطور,المطور الاساسي} فقط  \n" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Kara then return "𖤓 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
if not MsgText[2] and msg.reply_id then
...
if not msg.Kara then return "𖤓 **هذا الامر يخص {المطور,المنشى الاساسي فقط} فقط  \n" end
if not MsgText[2] and msg.reply_id then
...
local Admins = redis:scard(siria..'admins:'..msg.chat_id_)
redis:del(siria..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(siria..'owners:'..msg.chat_id_)
redis:del(siria..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(siria..'whitelist:'..msg.chat_id_)
redis:del(siria..'whitelist:'..msg.chat_id_)

return "𖤓 أهلاً عزيزي "..msg.TheRankCmd.." ↓\n𖤓 تم تنزيل ❴ "..Admins.." ❵ من الادمنيه\n𖤓 تم تنزيل ❴ "..NumMDER.." ❵ من المدراء\n𖤓 تم تنزيل ❴ "..MMEZEN.." ❵ من المميزين\n\n𖤓 تم تـنـزيـل الـكـل بـنـجـاح\n" 
end
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(siria..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(siria..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(siria..'ExCmdLink'..msg.chat_id_,120,true)
return sendMsg(msg.chat_id_,msg.id_,"𖤓 **تم انشاء رابط جديد \n𖤓 ["..LinkGp.."]\n𖤓 لعرض الرابط ارسل { الرابط } \n")
else
return sendMsg(msg.chat_id_,msg.id_,"𖤓 لا يمكنني انشاء رابط للمجموعه .\n𖤓 لانني لست مشرف في المجموعه \n")
end
else
return sendMsg(msg.chat_id_,msg.id_,"𖤓 لقد قمت بانشاء الرابط سابقا .\n𖤓 ارسل { الرابط } لرؤيه الرابط  \n")
end
return false
end 
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(siria..'linkGroup'..msg.sender_user_id_,300,true)
return '𖤓 عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(siria..'linkGroup'..msg.chat_id_) then 
return "𖤓 ** اوه لا يوجد رابط .\n𖤓 **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(siria..'group:name'..msg.chat_id_)
local GroupLink = redis:get(siria..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "𖤓 *│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
local GroupLink = redis:get(siria..'linkGroup'..msg.chat_id_)
if not GroupLink then return "𖤓 ** اوه لا يوجد هنا رابط\n𖤓 *رجائا اكتب [ضع رابط]*" end
local Text = "𖤓 رابـط الـمـجـمـوعه 𖤓 \n"..Flter_Markdown(redis:get(siria..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
if res == 403 then
return "𖤓 **عذرا عزيزي \n𖤓 لم استطيع ارسالك الرابط لانك قمت بحظر البوت\n!"
elseif res == 400 then
return "𖤓 **عذرا عزيزي \n𖤓 لم استطيع ارسالك الرابط يجب عليك مراسله البوت اولا \n!"
end
if res == 200 then 
return "𖤓 **أهلاً عزيزي "..msg.TheRankCmd.."  \n𖤓 تم ارسال الرابط خاص لك ."
end
end
...
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(siria..'rulse:witting'..msg.sender_user_id_,300,true)
return '𖤓 حسننا عزيزي  .\n𖤓 الان ارسل القوانين  للمجموعه .'
end

if MsgText[1] == "القوانين" then
if not redis:get(siria..'rulse:msg'..msg.chat_id_) then 
return "𖤓 **مرحباً عزيري القوانين كلاتي .\n𖤓 ممنوع نشر الروابط \n𖤓 ممنوع التكلم او نشر صور اباحيه \n𖤓 ممنوع  اعاده توجيه\n𖤓 ممنوع التكلم بالسياسة \n𖤓 الرجاء احترام المدراء والادمنيه\n"
else 
return "*𖤓 القوانين :*\n"..redis:get(siria..'rulse:msg'..msg.chat_id_) 
end 
end
...
return "𖤓 ** حدود التكرار ,  يجب ان تكون ما بين  *[2-50]*" 
end
redis:set(siria..'flood'..msg.chat_id_,MsgText[2]) 
return "𖤓 ** تم وضع التكرار » { *"..MsgText[2].."* }"
end
...
if MsgText[2] and MsgText[2]:match('^%d+$') then
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if 500 < tonumber(MsgText[2]) then return "𖤓 ** حدود المسح ,  يجب ان تكون ما بين  *[2-100]*" end
...
sendMsg(msg.chat_id_,msg.id_,"*𖤓 * تـم مسح ←  { *"..MsgText[2].."* } من الرسائل  \n")
end,nil))
else
pcall(tdcli_function({ID="DeleteMessages",chat_id_=msg.chat_id_,message_ids_=All_Msgs},function() 
sendMsg(msg.chat_id_,msg.id_,"*𖤓 * تـم مسح ←  { *"..MsgText[2].."* } من الرسائل  \n")
...
local Admins = redis:scard(siria..'admins:'..msg.chat_id_)
if Admins ==0 then  
return "𖤓 ** اوه هنالك خطأ .\n𖤓 عذراً لا يوجد ادمنيه ليتم مسحهم ." 
end
redis:del(siria..'admins:'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم مسح {"..Admins.."} من الادمنيه في البوت \n"
end


if MsgText[2] == "قائمه المنع" then
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(siria..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "𖤓 ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(siria..':Filter_Word:'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم مسح {*"..Mn3Word.."*} كلمات من المنع"
end
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(siria..'rulse:msg'..msg.chat_id_) then 
return "𖤓 عذراً لا يوجد قوانين ليتم مسحه \n!" 
end
redis:del(siria..'rulse:msg'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم حذف القوانين بنجاح"
end


if MsgText[2] == "الترحيب"  then
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(siria..'welcome:msg'..msg.chat_id_) then 
return "𖤓 ** اوه هنالك خطأ .\n𖤓 عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(siria..'welcome:msg'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم حذف الترحيب بنجاح \n"
end


if MsgText[2] == "المنشئ الاساسي" then
if not msg.SudoUser then return "𖤓 **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(siria..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "𖤓 عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(siria..':Hussain:'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓  تم مسح {* "..NumMnsha.." *} المنشى الاساسي \n𖤓"
end


if MsgText[2] == "المنشئيين" then
if not msg.SudoUser then return "𖤓 **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(siria..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "𖤓 عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(siria..':MONSHA_BOT:'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم مسح {* "..NumMnsha.." *} من المنشئيين\n"
end


if MsgText[2] == "المدراء" then
if not msg.Creator then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local NumMDER = redis:scard(siria..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "𖤓 عذراً لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(siria..'owners:'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم مسح {* "..NumMDER.." *} من المدراء  \n"
end

if MsgText[2] == 'المحظورين' then
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end

local list = redis:smembers(siria..'banned:'..msg.chat_id_)
if #list == 0 then return "*𖤓 لا يوجد مستخدمين محظورين  *" end
message = '𖤓 ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(siria..'banned:'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(siria..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "𖤓 ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(siria..'is_silent_users:'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم مسح {* "..MKTOMEN.." *} من المكتومين  \n"
end
...
local MMEZEN = redis:scard(siria..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*𖤓 *لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(siria..'whitelist:'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم مسح {* "..MMEZEN.." *} من المميزين  \n"
end
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(siria..'linkGroup'..msg.chat_id_) then
return "*𖤓 *لا يوجد رابط مضاف اصلا " 
end
redis:del(siria..'linkGroup'..msg.chat_id_)
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."   \n𖤓 تم مسح رابط المجموعه \n"
end
...
if not msg.Creator then return "𖤓 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(siria..'name:witting'..msg.sender_user_id_,300,true)
return "𖤓 حسننا عزيزي  .\n𖤓 الان ارسل الاسم  للمجموعه .\n"
end
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم مسح الصوره المجموعه .\n')
end
...
function(arg,data)
if data.ID == "Ok" then
--return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم تغيير صوره المجموعه ⠀\n')
elseif  data.code_ == 3 then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ليس لدي صلاحيه تغيير الصوره \n𖤓 يجب اعطائي صلاحيه `تغيير معلومات المجموعه ` ⠀\n')
end
end, nil)
end
...
redis:setex(siria..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
return '𖤓 حسننا عزيزي .\n𖤓 الان قم بارسال الصوره\n' 
end 
end
...
if not msg.Creator then return "𖤓 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(siria..'about:witting'..msg.sender_user_id_,300,true) 
return "𖤓 حسننا عزيزي .\n𖤓 الان ارسل الوصف  للمجموعه\n" 
end


if MsgText[1] == "طرد البوتات" then
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
tdcli_function({ID="GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''),
filter_ ={ID="ChannelMembersBots"},offset_ = 0,limit_ = 50},function(arg,data)
local Total = data.total_count_ or 0
if Total == 1 then
return sendMsg(msg.chat_id_,msg.id_,"𖤓 لا يـوجـد بـوتـات في الـمـجـمـوعـه .") 
else
local NumBot = 0
local NumBotAdmin = 0
...
local TextR  = "𖤓 عـدد الـبـوتات 𖤓⊱ {* "..(Total - 1).." *} ⊰𖤓\n\n"
if NumBot == 0 then 
TextR = TextR.."𖤓 لا يـمـكـن طردهم لانـهـم مشـرفـين .\n"
else
if NumBotAdmin >= 1 then
TextR = TextR.."𖤓 لم يتم طـرد {* "..NumBotAdmin.." *} بوت لأنهم مـشـرفين."
else
TextR = TextR.."𖤓 تم طـرد كــل البوتات بنجاح .\n"
end
end
...
filter_ ={ID= "ChannelMembersBots"},offset_ = 0,limit_ = 50},function(arg,data)
local total = data.total_count_ or 0
AllBots = '𖤓 قـائمه البوتات الـحالية\n\n'
local NumBot = 0
for k, v in pairs(data.members_) do
...
𖤓 لديك {]]..total..[[} بوتات
𖤓 ملاحظة : الـ ♚ تعنـي ان البوت مشرف في المجموعـة.]]
...
if not msg.Creator then return "𖤓 **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
sendMsg(msg.chat_id_,msg.id_,'𖤓 جارٍ البحث عن الحسابات المحذوفة ...')
tdcli_function({ID="GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100','')
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(siria..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(siria..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(siria..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(siria..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
if NumMem == Total then
if NumMemDone >= 1 then
sendMsg(msg.chat_id_,msg.id_,"𖤓 تم طـرد {* "..NumMemDone.." *} من الحسابات المحذوفه‏‏ .")
else
sendMsg(msg.chat_id_,msg.id_,'𖤓 لا يوجد حسابات محذوفه في المجموعه .')
end
end
end,nil)
end
...
if redis:get(siria..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(siria..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(siria..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(siria..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(siria..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(siria.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		if not redis:get("KLISH:ID") then
		sendMsg(msg.chat_id_,msg.id_,'𖤓لا يمكنني عرض صورتك لانك قمت بحظر البوت او انك لاتملك صوره في بروفيلك ...!\n✇-𝐍𝐀𝐌𝐄 :  ۦ '..Namei..'  \n✇-𝐔𝐒𝐄𝐑 : ۦ'..UserNameID..' .\n✇-𝐌𝐒𝐆𝐄⁞  : ۦ  '..msgs..' .\n✇-𝐒𝐓𝐀•|• : ۦ'..msg.TheRank..' .\n✇-𝐈𝐃  ۦ'..msg.sender_user_id_..' .\n✇-𝐂𝐇 : ۦ @SOURCE_SYRIA .\n▁')
		else
		Text = redis:get("KLISH:ID")
		Text = Text:gsub('IDGET',msg.sender_user_id_)
		Text = Text:gsub('USERGET',UserNameID)
	...
	if redis:get("KLISH:ID") then
		...
		sendMsg(msg.chat_id_,msg.id_,'𖤓الايدي بالصوره معطل \n𖤓✇-𝐍𝐀𝐌𝐄 :  ۦ '..Namei..'    \n✇-𝐔𝐒𝐄𝐑 : ۦ'..UserNameID..' .\n✇-𝐌𝐒𝐆𝐄⁞  : ۦ'..msgs..' .\n✇-𝐒𝐓𝐀•|• : ۦ'..msg.TheRank..' .\n✇-𝐈𝐃 ۦ : ۦ'..msg.sender_user_id_..' .\n✇-𝐂𝐇 ۦ : ۦ @SOURCE_SYRIA .')
		end
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(siria..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(siria..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(siria..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(siria..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(siria..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(siria..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(siria..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(siria..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(siria..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)

local Get_info =  " \n𖤓 ( الاحـصـائـيـات الـرسـائـلك )\n \n"
.."𖤓 الـرسـائـل ( "..msgs.." )\n"
.."𖤓 الـجـهـات ( "..NumGha.." )\n"
.."𖤓 الـصـور ( "..photo.." )\n"
.."𖤓 الـمـتـحـركـه ( "..animation.." )\n"
.."𖤓 الـمـلـصـقات ( "..sticker.." )\n"
.."𖤓 الـبـصـمـات ( "..voice.." )\n"
.."𖤓 الـصـوت ( "..audio.." )\n"
.."𖤓 الـفـيـديـو ( "..video.." )\n"
.."𖤓 الـتـعـديـل ( "..edited.." )\n"
...
local msgs = redis:get(siria..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if rfih == 0 then  return "𖤓 **عذرا لا يوجد رسائل لك في البوت  ." end
redis:del(siria..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "𖤓 **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '𖤓 **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(siria..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(siria..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "𖤓 **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(siria..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
return "𖤓 **تم مسح {* "..adduser.." *} من جهاتك\n𖤓"
end
...
local points = redis:get(siria..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "𖤓 **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(siria..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
return "𖤓 **تم مسح {* "..points.." *} من نقاطك\n"
end
...
local Get_info ="𖤓 اهلاً بك في معلوماتك . \n"
.."ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ\n"
.."𖤓 الأسم ( "..FlterName(data.first_name_..' '..(data.last_name_ or ""),25).." )\n"
.."𖤓 المعرف ( "..ResolveUser(data).." )\n"
.."𖤓 الأيدي ( `"..msg.sender_user_id_.."` )\n"
.."𖤓 رتبتك ( "..msg.TheRank.." )\n"
.."𖤓 ـ ( `"..msg.chat_id_.."` )\n"
.."ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ\n"
.." 𖤓 الأحصائيات الرسائل .\n"
.."𖤓 الرسائل ( `"..msgs.."` )\n"
.."𖤓 الجهات ( `"..NumGha.."` )\n"
.."𖤓 الصور ( `"..photo.."` )\n"
.."𖤓 المتحركه ( `"..animation.."` )\n"
.."𖤓 الملصقات ( `"..sticker.."` )\n"
.."𖤓 البصمات ( `"..voice.."` )\n"
.."𖤓 الصوت ( `"..audio.."` )\n"
.."𖤓 الفيديو ( `"..video.."` )\n"
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(siria..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(siria..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(siria..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(siria..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(siria..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(siria..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(siria..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(siria..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(siria..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)

local Get_info ="𖤓 أهلاً عزيزي تم مسح جميع معلوماتك "
return sendMsg(msg.chat_id_,msg.id_,Get_info)    
end,nil)
return false
end
...
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(siria..'welcom:witting'..msg.sender_user_id_,true) 
return "𖤓 حسننا عزيزي .\n𖤓 ارسل كليشه الترحيب الان\n\n𖤓 ملاحظه تستطيع اضافه دوال للترحيب مثلا :\n𖤓 أظهار قوانين المجموعه  » *{القوانين}*  \n𖤓  أظهار الاسم العضو » *{الاسم}*\n𖤓 أظهار المعرف العضو » *{المعرف}*\n𖤓 أظهار اسم المجموعه » *{المجموعه}*" 
end


if MsgText[1] == "الترحيب" then
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(siria..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(siria..'welcome:msg'..msg.chat_id_))
else 
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."  \n𖤓 نورت المجموعه \n" 
end 
end
...
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local mtwren = redis:scard(siria..':SUDO_BOT:')
if mtwren == 0 then  return "𖤓 ** عذراً لا يوجد مطورين في البوت ." end
redis:del(siria..':SUDO_BOT:') 
return "𖤓 ** تم مسح {* "..mtwren.." *} من المطورين .\n"
end

if MsgText[1] == 'مسح' and MsgText[2] == "قائمه العام"  then
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local addbannds = redis:scard(siria..'gban_users')
if addbannds ==0 then 
return "*𖤓 قائمة الحظر فارغه .*" 
end
redis:del(siria..'gban_users') 
return "𖤓 ** تـم مـسـح { *"..addbannds.." *} من قائمه العام\n" 
end 
...
local groups = redis:smembers(siria..'group:ids')
...
if GroupDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'𖤓 ** جـيـد , لا توجد مجموعات وهميه \n')
else
sendMsg(msg.chat_id_,msg.id_,'𖤓 ** عدد المجموعات 𖤓⊱ { *'..#groups..'*  } ⊰𖤓\n𖤓 ** تـم تنظيف  𖤓⊱ { *'..GroupDel..'*  } ⊰𖤓 مجموعه \n𖤓 ** اصبح العدد الحقيقي الان 𖤓⊱ { *'..GroupsIsFound..'*  } ⊰𖤓 مجموعه')
end
end
end)
end
...
local pv = redis:smembers(siria..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:srem(siria..'users',pv[i])
NumPvDel = NumPvDel + 1
end
if #pv == i then 
if NumPvDel == 0 then
sendMsg(msg.chat_id_,msg.id_,'𖤓 جـيـد , لا يوجد مشتركين وهمي')
else
local SenderOk = #pv - NumPvDel
sendMsg(msg.chat_id_,msg.id_,'𖤓 ** عدد المشتركين 𖤓⊱ { *'..#pv..'*  } ⊰𖤓\n𖤓 ** تـم تنظيف  𖤓⊱ { *'..NumPvDel..'*  } ⊰𖤓 مشترك \n𖤓 ** اصبح العدد الحقيقي الان 𖤓⊱ { *'..SenderOk..'*  } ⊰𖤓 من المشتركين') 
end
end
end)
end)
...
redis:setex(siria..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
return'𖤓 حسننا عزيزي .\n𖤓 الان قم بارسال الصوره للترحيب \n' 
end
...
local Photo_Weloame = redis:get(siria..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[𖤓 اهلا انا بوت]]..redis:get(siria..':NameBot:')..[[ .
𖤓 اختصاصي حماية‌‏ المجموعات
𖤓 مـن السبام والتوجيه‌‏ والتكرار والخ...

𖤓 مـعـرف الـمـطـور  » ]]..SUDO_USER:gsub([[\_]],'_')..[[ .
]])

return false
else
return "𖤓 لا توجد صوره مضافه للترحيب في البوت \n𖤓 لاضافه صوره الترحيب ارسل `ضع صوره للترحيب`"
end
end

if MsgText[1] == "ضع كليشه المطور" then 
redis:setex(siria..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '𖤓 حسننا عزيزي .\n𖤓 الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(siria..':addnumberusers',MsgText[2]) 
return '𖤓 ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'𖤓 ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(siria..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "𖤓 **هذا الامر يخص {المطور} فقط  \n" end
return '𖤓 ** عدد المجموعات المفعلة » `'..redis:scard(siria..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "𖤓 **هذا الامر يخص {المطور} فقط  \n" end
return '𖤓 **عدد المشتركين في البوت : `'..redis:scard(siria..'users')..'` \n'
end

if MsgText[1] == 'قائمه المجموعات' then 
if not msg.SudoBase then return "𖤓 **هذا الامر يخص {المطور} فقط  \n" end
return chat_list(msg) 
end

if MsgText[1] == 'تعطيل' and MsgText[2] and MsgText[2]:match("-100(%d+)") then
if not msg.SudoUser then return "𖤓 **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(siria..'group:ids',MsgText[2]) then
local name_gp = redis:get(siria..'group:name'..MsgText[2])
sendMsg(MsgText[2],0,'𖤓 ** تم تعطيل المجموعه بأمر من المطور  \n𖤓 ** سوف اغادر ...\n✘')
rem_data_group(MsgText[2])
StatusLeft(MsgText[2],our_id)
return '𖤓 ** تم تعطيل المجموعه ومغادرتها \n𖤓 ** المجموعة » ['..name_gp..']\n𖤓 ** الايدي » ( *'..MsgText[2]..'* )\n'
else 
return '𖤓 ** لا توجد مجموعه مفعله بهذا الايدي .\n ' 
end 
end 

if MsgText[1] == 'المطور' then
return redis:get(siria..":TEXT_SUDO") or '𖤓 لا توجد كليشه المطور .\n𖤓 يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="ااذاعه بالتثبيت ♥" then
if not msg.SudoUser then return"𖤓 **هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(siria..'lock_brod') then return "𖤓 ** الاذاعه مقفوله من قبل المطور الاساسي ." end
redis:setex(siria..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "𖤓 حسننا الان ارسل الكليشه للاذاعه بالتثبيت  \n ♥" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"𖤓 **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(siria..'lock_brod') then 
return "𖤓 ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(siria..'fwd:'..msg.sender_user_id_,300, true) 
return "𖤓 حسننا الان ارسل التوجيه للاذاعه \n" 
end
...
redis:setex(siria..'fwd:all'..msg.sender_user_id_,300, true) 
return "𖤓 حسننا الان ارسل الكليشه للاذاعه عام \n" 
end
...
redis:setex(siria..'fwd:pv'..msg.sender_user_id_,300, true) 
return "𖤓 حسننا الان ارسل الكليشه للاذاعه خاص \n"
end
...
redis:setex(siria..'fwd:groups'..msg.sender_user_id_,300, true) 
return "𖤓 حسننا الان ارسل الكليشه للاذاعه للمجموعات \n" 
end
...
return "𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" 
end
...
if MsgText[1] == "رتبتي" then return '𖤓 ** رتبتك هنا 𖣄 ←  ( '..msg.TheRank..' )\n' end

----------------- استقبال الرسائل ---------------
if MsgText[1] == "الغاء الامر ✖️" or MsgText[1] == "الغاء" then
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(siria..'welcom:witting'..msg.sender_user_id_,
siria..'rulse:witting'..msg.sender_user_id_,
siria..'rulse:witting'..msg.sender_user_id_,
siria..'name:witting'..msg.sender_user_id_,
siria..'about:witting'..msg.sender_user_id_,
siria..'fwd:all'..msg.sender_user_id_,
siria..'fwd:pv'..msg.sender_user_id_,
siria..'fwd:groups'..msg.sender_user_id_,
siria..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
siria..'namebot:witting'..msg.sender_user_id_,
siria..'addrd_all:'..msg.sender_user_id_,
siria..'delrd:'..msg.sender_user_id_,
siria..'addrd:'..msg.sender_user_id_,
siria..'delrdall:'..msg.sender_user_id_,
siria..'text_sudo:witting'..msg.sender_user_id_,
siria..'addrd:'..msg.chat_id_..msg.sender_user_id_,
siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return '𖤓 ** تم إلغاء الأمر بنجاح .  \n'
end  
...
redis:set(siria..":VERSION",GetVerison)
return false
else
...
return '𖤓 اصدار سورس سوريا : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'𖤓 ** جارٍ رفع النسخه انتظر قليلا ... \n')
end
end,nil)
else 
sendMsg(msg.chat_id_,msg.id_,"𖤓 ** عذراً النسخه الاحتياطيه هذا ليست للبوت » ["..Bot_User.."]  \n")
end
else 
sendMsg(msg.chat_id_,msg.id_,'𖤓 ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سوريا يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
sendMsg(msg.chat_id_,msg.id_,'𖤓 ** عذراً الملف ليس بصيغه Json !?\n')
end 
else
sendMsg(msg.chat_id_,msg.id_,'𖤓 ** عذراً هذا ليس ملف النسحه الاحتياطيه للمجموعات\n')
end 
end,nil)
else 
return "𖤓 ** ارسل ملف النسخه الاحتياطيه اولا\n𖤓 ** ثم قم بالرد على الملف وارسل \" `رفع نسخه الاحتياطيه` \" "
end 
return false
end
...
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return "𖤓 البوت شـغــال ." 
end

if (MsgText[1]== "ايدي" or MsgText[1]=="ID") and msg.type == "pv" then return  "\n𖤓 اهلاً عزيزي المطور ايديك :\n\n𖤓 "..msg.sender_user_id_.."\n"  end

if MsgText[1]== "قناة السورس" and msg.type == "pv" then
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/SOURCE_SYRIA"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : سوريا](https://t.me/SOURCE_SYRIA)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المبرمج سوريا" and msg.type == "pv" then
local inline = {{{text="-مبرمج آلسـورس اضـغـط هـنـآ ",url="https://t.me/SIRIA199"}}}
send_key(msg.sender_user_id_,'   [مبرمج السورس سوريا](https://t.me/SIRIA199)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المطور عرابي" and msg.type == "pv" then
local inline = {{{text="-مطور السورس اضـغـط هـنـآ ",url="https://t.me/DEV_ORABI"}}}
send_key(msg.sender_user_id_,'   [مطور السورس](https://t.me/DEV_ORABI)' ,nil,inline,msg.id_)
return false
end
...
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '𖤓 الاحصائيات . \n\n𖤓 **عدد المجموعات المفعله : '..redis:scard(siria..'group:ids')..'\n𖤓 **عدد المشتركين في البوت : '..redis:scard(siria..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(siria..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "𖤓 حسننا الان ارسل كلمة الرد العام .\n"
end


if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(siria..'replay:'..msg.chat_id_)
local photo 	= redis:exists(siria..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(siria..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(siria..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(siria..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(siria..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(siria..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(siria..'replay:'..msg.chat_id_,siria..'replay_photo:group:'..msg.chat_id_,siria..'replay_voice:group:'..msg.chat_id_,
siria..'replay_animation:group:'..msg.chat_id_,siria..'replay_audio:group:'..msg.chat_id_,siria..'replay_sticker:group:'..msg.chat_id_,siria..'replay_video:group:'..msg.chat_id_)
return "𖤓 تم مسح كل الردود ."
else
return '𖤓 ** لا يوجد ردود ليتم مسحها \n'
end
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود العامه' then
if not msg.SudoBase then return"𖤓 للمطورين فقط ." end
local names 	= redis:exists(siria..'replay:all')
local photo 	= redis:exists(siria..'replay_photo:group:')
local voice 	= redis:exists(siria..'replay_voice:group:')
local imation 	= redis:exists(siria..'replay_animation:group:')
local audio 	= redis:exists(siria..'replay_audio:group:')
local sticker 	= redis:exists(siria..'replay_sticker:group:')
local video 	= redis:exists(siria..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(siria..'replay:all',siria..'replay_photo:group:',siria..'replay_voice:group:',siria..'replay_animation:group:',siria..'replay_audio:group:',siria..'replay_sticker:group:',siria..'replay_video:group:')
return "𖤓 تم مسح كل الردود العامه ."
else
return "𖤓 لا يوجد ردود عامه ليتم مسحها ."
end
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد عام' then
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(siria..'delrdall:'..msg.sender_user_id_,true) 
return "𖤓 حسننا عزيزي  .\n𖤓 الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(siria..'delrd:'..msg.sender_user_id_,true)
return "𖤓 حسننا عزيزي  .\n𖤓 الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "𖤓 *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(siria..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(siria..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(siria..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(siria..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(siria..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(siria..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(siria..'replay_video:group:'..msg.chat_id_)
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '𖤓 **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
local message = '𖤓 **ردود البوت في المجموعه  :\n\n'
...
if not msg.SudoBase then return "𖤓 للمطور فقط ." end
local names 	= redis:hkeys(siria..'replay:all')
local photo 	= redis:hkeys(siria..'replay_photo:group:')
local voice 	= redis:hkeys(siria..'replay_voice:group:')
local imation 	= redis:hkeys(siria..'replay_animation:group:')
local audio 	= redis:hkeys(siria..'replay_audio:group:')
local sticker 	= redis:hkeys(siria..'replay_sticker:group:')
local video 	= redis:hkeys(siria..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '𖤓 **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
local message = '𖤓 **الردود العامه في البوت :   :\n\n'
for i=1, #photo 	do message = message ..ii..' - *{* '..	photo[i]..' *}_*( صوره ) \n' 	ii = ii + 1 end
for i=1, #names 	do message = message ..ii..' - *{* '..	names[i]..' *}_*( نص ) \n'  	ii = ii + 1 end
for i=1, #voice 	do message = message ..ii..' - *{* '..	voice[i]..' *}_*( بصمه ) \n' 	ii = ii + 1 end
for i=1, #imation 	do message = message ..ii..' - *{* '..imation[i]..' *}_*( متحركه ) \n'ii = ii + 1 end
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(siria..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "𖤓 حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(siria..'namebot:witting'..msg.sender_user_id_,300,true)
return"𖤓 حسننا عزيزي .\n𖤓 الان ارسل الاسم  للبوت ."
end



if MsgText[1] == 'server' then
if not msg.SudoUser then return "𖤓 للمطور فقط." end
return io.popen([[
...
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓م1 ≫ اوامر الإداره .‌‏
𖤓م2 ≫ اوامر اعدادات المجمّوعه .‌‏
𖤓م3 ≫ اوامر الحِمايـه .
𖤓م4 ≫ اوامر الخِدمـه .
𖤓م5 ≫ اوامر التسـليه .
𖤓م6 ≫ اوامر التعَطيل و التفَعيل .
𖤓م7 ≫ اوامر الوضع للمجموعه .
𖤓م8 ≫ اوامر التسليه الجديده .
𖤓م9 ≫ اوامر الروايات .
𖤓م10 ≫ اوامر تريمكس .
𖤓م المطور ≫ اوامر آلمـطـور .
𖤓  اوامر الرد ≫ لاضـافة‌‏ رد مـعين .
𖤓الوسائط ≫ لمعرفه الاعدادات 
𖤓الاعدادات ≫ اعدادات المجموعه .
𖤓السورس ≫ سورس البوت
𖤓المطور  ≫ مطور البوت
 ≪━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐑𝐈𝐀 𖤓━━≫
 𖤓 يُـوزر المّـطور ≫{ ]]..SUDO_USER..[[ } 𖤓 ]]
end
if MsgText[1]== 'م1' then
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤓 " end
local text =[[     
١ 𖤓 اوامـر الرفع و التنزيل .
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓رفع ≪━≫ تنزيل مـدير .
𖤓رفع ≪━≫  تنزيل ادمن .
𖤓رفع ≪━≫ تنزيل مميز .
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
       ٢ 𖤓 اوامـر المسح للمنشئ .
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
 𖤓مسح الادمنـيـه ≫ لمسح الادمنيه
 𖤓مسح المميزين ≫ لمسح المميزين 
 𖤓مسح المـــدراء ≫ لمسح المدراء 
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
      ٣ 𖤓 اوامـر الحظـر والطــرد والتقييد .
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
 𖤓حظر بالرد ≪━≫ بالمعرف ≫ لحظر العضو
 𖤓الغاء الحظر بالرد ≪━≫ بالمعرف ≫ لالغاء الحظر 
 𖤓طرد بالرد ≪━≫ بالمعرف ≫ لطرد العضو
 𖤓كتم بالرد ≪━≫ بالمعرف ≫ لكتم العضو 
 𖤓الغاء الكتم بالرد ≪━≫ بالمعرف ≫ لالغاء الكتم 
 𖤓تقييد بالرد  ≪━≫ بالمعرف ≫ لتقييد العضو
 𖤓فك التقييد  بالرد ≪━≫ بالمعرف ≫ لالغاء تقييد العضو
 𖤓منع + الكلمه  ≫ لمنع الكلمه
 𖤓الغاء منع ≫ لالغاء منع الكلمه
≪━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐑𝐈𝐀 𖤓━━≫
 𖤓 يُـوزر المّـطور ≫{ ]]..SUDO_USER..[[ } 𖤓 ]]
...
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤓 " end
local text = [[
𖤓 اوامر رؤية الاعدادات
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓الـرابـط ≫ لعرض الرابط 
𖤓انشاء رابط ≫ لِستخراج رابط جديد 
𖤓الادمنيه ≫ لعرض الادمنيه
𖤓القوانين ≫ لعرض القوانين 
𖤓الوسائط ≫ لعرض اعدادات الميديا
𖤓الحمايـه ≫ لعرض كل الاعدادات
𖤓المــدراء ≫ لعرض الاداريين
𖤓المكتومين ≫ لعـرض المكتومين 
𖤓المحظورين ≫ لعرض المحظورين
𖤓الاعدادات ≫ لعرض اعدادات المجموعه 
𖤓المجموعه ≫ لعرض معلومات المجموعه
𖤓تغير امر + الامر ≫ لتغير اوامر البوت 
𖤓مسح امر + الامر ≫ لمسح الامر المضاف
𖤓قائمـه الاوامر ≫ لمعرفه الاوامرالمضافه 
 ≪━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐑𝐈𝐀 𖤓━━≫
 𖤓 يُـوزر المّـطور ≫{ ]]..SUDO_USER..[[ } 𖤓 ]]
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤓 " end
local text = [[
١ 𖤓 اوامر حمايـة المجموعه
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓قفل ≪━≫ فتح ≫ الكُل 
𖤓قفل ≪━≫ فتح ≫ التـاك
𖤓قفل ≪━≫ فتح ≫ الفيـديـــو
𖤓قفل ≪━≫ فتح ≫ الصــــــــور 
𖤓قفل ≪━≫ فتح ≫ الملصقات
𖤓قفل ≪━≫ فتح ≫ المتحركه
𖤓قفل ≪━≫ فتح ≫ البصمــات   
𖤓قفل ≪━≫ فتح ≫ الدردشـــه
𖤓قفل ≪━≫ فتح ≫ الــروابـــط
𖤓قفل ≪━≫ فتح ≫ البـــوتــات
𖤓قفل ≪━≫ فتح ≫ التعــديــل
𖤓قفل ≪━≫ فتح ≫ المعرفــات
𖤓قفل ≪━≫ فتح ≫ الكـــلايـش
𖤓قفل ≪━≫ فتح ≫ التـــكـــــرار
𖤓قفل ≪━≫ فتح ≫ الجــهـــــات
𖤓قفل ≪━≫ فتح ≫ الانـــلايــن
𖤓قفل ≪━≫ فتح ≫ التوجيــــه
𖤓قفل ≪━≫ فتح ≫ الدخول بالرابط
𖤓قفل ≪━≫ فتح ≫ البوتات بالطرد
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
       ٢ 𖤓 القفل بالتقييـد
                                              
𖤓قفل ≪━≫ فتح ≫ الــصــــــور بالتقييـد
𖤓قفل ≪━≫ فتح ≫ الــروابــط بالتقييـد 
𖤓قفل ≪━≫ فتح ≫ المتحركه بالتقييـد
𖤓قفل ≪━≫ فتح ≫ الفيـــديــو بالتقييد
𖤓قفل ≪━≫ فتح ≫ التوجيــه بالتقييــد
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير,المطور} فقط  \n𖤓 " end
local text = [[
𖤓  اوامر الخدمــه .
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ 
𖤓ايـدي ≫ لعرض صورتك + معلوماتك
𖤓ايديـي  ≫ لعرض ايديك  
𖤓ايدي بالرد ≫ لعرض ايدي الشخص
𖤓الرابط  ≫ لظهور رابط المجموعه
𖤓جهاتي ≫ لمعرفه عدد جهاتك
𖤓الالعاب ≫ لعرض العاب البوت 
𖤓نقاطي  ≫ لمعرفه عدد نقاطك
𖤓بيع نقاطي  + العدد ≫ لبيع نقاطك
𖤓معلوماتي ≫ لعرض معلوماتك
𖤓السورس  ≫ لعرض سورس البوت
𖤓الرتبه بالرد ≫ لمعرفه رتبه الشخص
𖤓التفاعل ≫ بالمعرف او بالرد لمعرفه تفاعل الشخص
𖤓كشف بالمعرف او بالرد ≫ لمعرفه معلومات حسابه
𖤓كشف البوتات ≫ لاظهار عدد البوتات الموجوده بالمجموعه
𖤓طرد البوتات ≫ لطرد كل البوتات
𖤓طرد المحذوفين ≫ لطرد الحسابات المحذوفه
𖤓رابط الحذف ≫ لحذف حساب التليجرام
≪━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐑𝐈𝐀 𖤓━━≫ 
 𖤓 يُـوزر المّـطور ≫{ ]]..SUDO_USER..[[ } 𖤓 ]]
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
𖤓 اوامـر التسليـه .
 𖤓مرحباً عزيزي 
 𖤓إليـك اوامر التسليـه كـ التالي
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
...
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤓 " end
local text = [[     
𖤓 اوامـر التعطِيل و التفعِيل .
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
 𖤓تفعيل ≪━≫ تعطيل ≫ الرفــع 
 𖤓تفعيل ≪━≫ تعطيل ≫ الردود 
 𖤓تفعيل ≪━≫ تعطيل ≫ الالعـاب
 𖤓تفعيل ≪━≫ تعطيل ≫ التحذير 
 𖤓تفعيل ≪━≫ تعطيل ≫ الترحيب 
 𖤓تفعيل ≪━≫ تعطيل ≫ الايدي 
 𖤓تفعيل ≪━≫ تعطيل ≫ الايدي بالصوره 
≪━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐑𝐈𝐀 𖤓━━≫
 𖤓 يُـوزر المّـطور ≫{ ]]..SUDO_USER..[[ } 𖤓 ]]
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤓 " end
local text = [[
𖤓 اوامر الوضع للمجمّوعة :
    
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
      
 𖤓ضع رابـط ≫ لوضع رابط 
 𖤓ضع اســـم ≫ لوضع اســم 
 𖤓ضع صوره ≫ لوضع صوره 
 𖤓ضع وصـف ≫ لوضع وصف 
 𖤓ضع القوانيــن ≫ لوضع القوانين 
 𖤓ضع الترحيب ≫ لوضع ترحيــب 
 𖤓ضع تكرار +العدد ≫ لوضع تكرار 
...
local text = [[
 ...
 𖤓مرحباً عزيزي 
 𖤓إليـك الاوامر كـ التالي
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓الروايات
 
 سيتم اضافه باقي المميزات قريبا .
≪━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐑𝐈𝐀 𖤓━━≫
 𖤓 يُـوزر المّـطور ≫{ ]]..SUDO_USER..[[ { ]]
sendMsg(msg.chat_id_,msg.id_,text)
return false
end
...
if not msg.SudoBase then return "𖤓 للمطور الاساسي فقط  🎖" end
local text = [[     
↤︎ ❬اوامـر المطـور❭ 
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓 تفعيـل ≪━≫ ❬لتفعيل البوت ❭
𖤓 تعطيل ≪━≫ ❬لتعطيل البوت ❭
𖤓 رفع منشى ≪━≫ ❬رفع منشى بالبوت❭
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓 اذاعه ≪━≫ ❬لنشر رساله لكل المجموعات❭
𖤓 اذاعه خاص ≪━≫ ❬ لنشر رساله لكل المشتركين خاص❭
𖤓 اذاعه عام ≪━≫ ❬لنشر رساله لكل المجموعات والخاص❭
𖤓 اذاعه عام بالتوجيه ≪━≫ ❬لنشر منشور قناتك بابتوجيه للكل❭
𖤓 اذاعه ≪━≫ ❬التثبيت رساله لكل المجموعات❭
𖤓 تنظيف المجموعات≪━≫  ❬لمسح المجموعات الوهميه❭
تنظيف المشتركين ≪━≫ ❬لمسح المشتركين الوهميين❭
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓 تحديث ≪━≫ ❬لتحديث ملفات البوت❭
𖤓 تحديث السورس ≪━≫ ❬لتحديث السورس الى اصدار احدث❭
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
 𖤓 يُـوزر المّـطور ≫{ ]]..SUDO_USER..[[ } 𖤓 ]]
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
if not msg.Director then return "𖤓 **هذا الامر يخص {المطور,المنشئ,المدير,المطور} فقط  \n𖤓 " end
local text = [[
𖤓 حسنا الان قم بكتابه اسم البرج
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
...
↤︎❬جميع اوامر الردود ❭
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
𖤓 الردود ≪━≫ لعرض الردود المثبته
𖤓 اضف رد ≪━≫ لأضافه رد جديد
𖤓 مسح رد ≪━≫ الرد المراد مسحه
𖤓 مسح الردود ≪━≫ لمسح كل الردود
𖤓 الردود العامه ≪━≫ لمعرف الردود المثبته عام 
𖤓 اضف رد عام ≪━≫ لاضافه رد لكل المجموعات
𖤓 مسح رد عام  ≪━≫ لمسح الرد العام 
𖤓 مسح الردود العامه ≪━≫ لمسح كل ردود العامه
ــــــــــــــــــــــ𖤓ـــــــــــــــــــــ
 𖤓 يُـوزر المّـطور ≫{ ]]..SUDO_USER..[[ } 𖤓 ]]
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤓 " end
if not redis:get(siria..'lave_me'..msg.chat_id_) then 
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** المغادره بالتاكيد تم تفعيلها\n𖤓" 
else 
redis:del(siria..'lave_me'..msg.chat_id_) 
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** تم تفعيل المغادره \n𖤓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "𖤓 **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n𖤓 " end
if redis:get(siria..'lave_me'..msg.chat_id_) then 
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** المغادره من قبل البوت بالتأكيد معطله\n𖤓" 
else
redis:set(siria..'lave_me'..msg.chat_id_,true)  
return "𖤓 **أهلا عزيزي "..msg.TheRankCmd.."\n𖤓 ** تم تعطيل المغادره من قبل البوت\n𖤓" 
end   
end

if MsgText[1] == "اطردني" or MsgText[1] == "احظرني" then
if not redis:get(siria..'lave_me'..msg.chat_id_) then
if msg.Admin then return "𖤓 **لا استطيع طرد المدراء والادمنيه والمنشئين  \n𖤓 " end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"𖤓 أهلاً عزيزي , لقد تم طردك من المجموعه بامر منك \n𖤓 اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n𖤓 فهذا رابط المجموعه\n𖤓 "..Flter_Markdown(redis:get(siria..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(siria..'linkGroup'..msg.chat_id_).."]\n")
sendMsg(msg.chat_id_,msg.id_,"𖤓 لقد تم طردك بنجاح , ارسلت لك رابط المجموعه في الخاص اذا وصلت لك تستطيع الرجوع متى شئت ")
else
sendMsg(msg.chat_id_,msg.id_,"𖤓  لا استطيع طردك لانك مشرف في المجموعه  ")
end
end)
return false
end
...
if MsgText[1] == "السورس" or MsgText[1]=="سورس" or MsgText[1]=="يا سورس"  then
local keyboard = {}
keyboard.inline_keyboard = {
{{text = '- 𝑫𝑬𝑽 𝑺𝑰𝑹𝑰𝑨 𖡛“ .',url="https://t.me/SIRIA199"}},
{{text = '- 𝑫𝑬𝑽 𝑶𝑹𝑨𝑷𝑰 𖡛 .',url="https://t.me/DEV_ORABI"}},
{{text = '- 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𖡚℡ .',url="https://t.me/SOURCE_SYRIA"}},
{{text = '- اضــف البوت الـي مـجـمـوعـتـك .',url="https://t.me/SY_RI_Abot?startgroup=start"}},
}   
send_inline(msg.chat_id_,  "𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑻𝑯𝑬 𝑴𝑶𝑺𝑻 𝑷𝑶𝑾𝑬𝑹𝑭𝑼𝑳 𝑺𝑶𝑼𝑹𝑪𝑬𝑺 𝑶𝑵 𝑻𝑯𝑬 𝑻𝑬𝑳𝑬𝑮𝑹𝑨𝑴 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝒀𝑹𝑰𝑨 𖡛“" ,keyboard,'html')
end
...
return "\n𖤓  الـتـاريـخ : "..os.date("%Y/%m/%d")
end

if MsgText[1]== "سحكاتي" then
return '𖤓 **عدد سحكاتك ⇜ ❪ '..(redis:get(siria..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'سحكاتي'  then
local rfih = (redis:get(siria..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
if rfih == 0 then  return "𖤓 *│* لا يوجد سحكات لك في البوت ." end
redis:del(siria..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
return "𖤓 *│*تم مسح {* "..rfih.." *} من سحكاتك .\n"
end

if MsgText[1] == "تفعيل الاشتراك الاجباري" or MsgText[1] == "تفعيل الاشتراك الاجباري ☑" then
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
if redis:get(siria..":UserNameChaneel") then
return "𖤓 اهلا عزيزي المطور \n𖤓 الاشتراك بالتأكيد مفعل"
else
redis:setex(siria..":ForceSub:"..msg.sender_user_id_,350,true)
return "𖤓 مرحبا بـك في نظام الاشتراك الاجباري\n𖤓 الان ارسل معرف قـنـاتـك"
end
end

if MsgText[1] == "تعطيل الاشتراك الاجباري" or MsgText[1] == "تعطيل الاشتراك الاجباري ♻️" then
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(siria..":UserNameChaneel")
if SubDel == 1 then
return "𖤓 تم تعطيل الاشتراك الاجباري . \n𖤓"
else
return "𖤓 الاشتراك الاجباري بالفعل معطل . \n𖤓"
end
end

if MsgText[1] == "الاشتراك الاجباري" or MsgText[1] == "الاشتراك الاجباري ⚠️" then
if not msg.SudoBase then return"𖤓 **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(siria..":UserNameChaneel")
if UserChaneel then
return "𖤓 اهلا عزيزي المطور \n𖤓 الاشتراك الاجباري للقناة : ["..UserChaneel.."]\n"
else
return "𖤓 لا يوجد قناة مفعله على الاشتراك الاجباري . \n"
end
end
...
if redis:get(siria..'welc'..msg.chat_id_) == 'on' then
if msg.content_.ID == 'MessageChatJoinByLink' then
function WelcomeByAddUser(BlaCk,Diamond)
local function setlinkgp(td,mrr619)
function gps(arg,data)

txt = '𖤓 اهلآ عزيزي '..(Diamond.first_name_ or '---')..'\n𖤓 المجموعه  '..(data.title_ or '---')..' \n𖤓 احترام الادمنيه\n𖤓 ممنوع طلب الرتب\n𖤓 ممنوع السب \n𖤓 ممنوع التكلم بالسياسة\n𖤓 الاعضاء '..mrr619.member_count_..' عضو\n𖤓 الادمنيه '..mrr619.administrator_count_..' \n𖤓 وقت الانضمام :【*'..os.date("%H:%M:%S")..'*】\n𖤓 تاريخ الانضمام :【*'..os.date("%Y/%m/%d")..'*】\n'
...
local hash = siria..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
if not msg.Kara then return "𖤓 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(siria,diamond)

if msg.can_promote_members == false then

sendMsg(msg.chat_id_,msg.id_,'𖤓 البوت لايمتلك  صلاحية رفع مشرف')
...
sendMsg(msg.chat_id_,msg.id_,'𖤓 الأسم : ['..data.first_name_..'](tg://user?id='..diamond.sender_user_id_..')\n𖤓 تم رفعه مشرف بكامل الصلاحيات\n‏‏')
...
function remadmins(siria,diamond)
...
mmd = redis:get(siria..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(siria..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(siria..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'𖤓 اهلا عزيزي \n𖤓 تم تثبيت الامر الجديد\n𖤓')
redis:del(siria..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "𖤓 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(siria..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
sendMsg(msg.chat_id_,msg.id_,'𖤓 اهلا بك عزيزي\n𖤓 الامر الي تريد تغيره الي  "'..cmd..'" \n𖤓 ارسله الان\n')
end

if Black and (Black:match('^delcmd (.*)') or Black:match('^مسح امر (.*)')) then
if not msg.Kara then return "𖤓 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('^delcmd (.*)') or Black:match('^مسح امر (.*)')
redis:hdel(siria..'CmD:'..msg.chat_id_,cmd)
redis:srem(siria..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"𖤓 اهلا عزيزي\nالامر >"..cmd.."\n𖤓 تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "𖤓 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(siria..'CmD:'..msg.chat_id_)
redis:del(siria..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"𖤓 اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "𖤓 **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(siria..'CmDlist:'..msg.chat_id_)
local t = '𖤓 قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(siria..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
t = '𖤓 عزيزي لم تقم ب اضافه امر .'
end
...
redis:set(siria..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(siria..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(siria..'welc'..msg.chat_id_,'off')
redis:del(siria..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب')
end
end

if Black == 'welcome on' or Black == 'تفعيل السوريا تيم' then
if redis:get(siria..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل السوريا تيم سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل السوريا تيم')
redis:set(siria..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تيم السوريا' then
if redis:get(siria..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم السوريا سابقا')
redis:set(siria..'welc'..msg.chat_id_,'off')
redis:del(siria..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم السوريا الترحيب')
end
end


if Text == "join on" and msg.SudoUser then
redis:set(siria..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'on')
end
if Text and redis:get(siria..'setchs') and msg.SudoUser then
redis:set(siria..'setch',Text)
sendMsg(msg.chat_id_,msg.id_,'تم تعين القناه علي \n'..Text)
redis:del(siria..'setchs')
end
if Text and (Text:match("^setch$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(siria..'setchs',120,true)
end
...
sendMsg(msg.chat_id_,msg.id_,'𖤓 عزيزي المستخدم\n𖤓 الامر فقط للصوره\n')
end
end
...
function tophoto(kara,siria)   
if siria.content_.ID == "MessageSticker" then        
local bd = siria.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(siria..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(siria..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*𖤓 * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(siria..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس سوريا\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي اريده‏'
local keyboard = {
{"المطور عرابي","المبرمج سوريا"},
{"مصنع بوتات المبرمج"},
{"بوت ماركت المبرمج"},
{"بوت دعم قنوات المبرمج"},
{"ضع اسم للبوت","ضع صوره للترحيب"},
{"تفعيل السوريا تيم","تعطيل تيم السوريا"},
...
redis:sadd(siria..'users',msg.sender_user_id_)
if redis:get(siria..'lock_service') then 
text = [[𖤓 أهلاً انا بوت   []]..redis:get(siria..':NameBot:')..[[] 🗽
𖤓 أختصاصي حماية المجموعات ..
𖤓 مـن السبام والتوجيه والتكرار والخ..
𖤓 لتفعيل البوت اتبع الشـروط ..
1- اضف البوت الى المجموعه
2- ارفع البوت مشرف في المجموعه
2- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائياً .

ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
 𖤓 مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
else
text = [[𖤓 أهلاً انا بوت    []]..redis:get(siria..':NameBot:')..[[] 🗽
𖤓 أختصاصي حماية المجموعات ..
...
local inline = {{{text="مـطـور الـبـوت 𖤓",url="t.me/"..xsudouser}}}
...
local MSG_ID = (redis:get(siria.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
SendMention(msg.sender_user_id_,data.id_,msg.id_,"𖤓 تم ارسال الرسالة .\n𖤓 إلى : "..USERNAME.." .",39,USERCAR) 
return false 
end,nil)
end  
end,nil)
...
if not redis:get(siria..'lock_twasel') then
if msg.forward_info_ or msg.sticker or msg.content_.ID == "MessageUnsupported" then
sendMsg(msg.chat_id_,msg.id_,"𖤓 عذراً لا يمكنك ارسال { توجيه‌‏ , ملصق , فديو كام} .")
return false
end
redis:setex(siria.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
sendMsg(msg.chat_id_,msg.id_,"𖤓 تم آرسـآل رسالتك إلى المطور\n𖤓 سـآرد عليك في اقرب وقت ممكن \n𖤓 معرف المطور "..SUDO_USER)
...
--====================== Reply Only Group ====================================
if redis:get(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(siria..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(siria..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(siria..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n𖤓 تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(siria..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه صوره للرد بنجاح\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(siria..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه بصمه صوت للرد بنجاح\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(siria..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه متحركه للرد بنجاح\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(siria..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه فيديو للرد بنجاح\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(siria..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه للصوت للرد بنجاح\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(siria..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه ملصق للرد بنجاح\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الملصق الاتي ')
end  

end

--====================== Reply All Groups =====================================
if redis:get(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(siria..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(siria..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(siria..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  𖤓 تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(siria..'replay_photo:group:',klma,photo_id)
redis:del(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه صوره للرد العام\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(siria..'replay_voice:group:',klma,voice_id)
redis:del(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه بصمه صوت للرد العام\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(siria..'replay_animation:group:',klma,animation_id)
redis:del(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه متحركه للرد العام\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(siria..'replay_video:group:',klma,video_id)
redis:del(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه فيديو للرد العام\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(siria..'replay_audio:group:',klma,audio_id)
redis:del(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه للصوت للرد العام\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(siria..'replay_sticker:group:',klma,sticker_id)
redis:del(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم اضافه ملصق للرد العام\n𖤓 يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الملصق الاتي ')
end  
...
if redis:get(siria..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(siria..":ForceSub:"..msg.sender_user_id_)
local url , res = https.request(ApiToken..'/getchatmember?chat_id='..msg.text..'&user_id='..msg.sender_user_id_)
if res == 400 then
local Req = JSON.decode(url)
if Req.description == "Bad Request: chat not found" then 
sendMsg(msg.chat_id_,msg.id_,"𖤓 عذراً , هناك خطأ لديك \n𖤓 المعرف الذي ارسلته ليس معرف قناة.")
return false
elseif Req.description == "Bad Request: CHAT_ADMIN_REQUIRED" then
sendMsg(msg.chat_id_,msg.id_,"𖤓 عذراً , لقد نسيت شيئا \n𖤓 يجب رفع البوت مشرف في قناتك لتتمكن من تفعيل الاشتراك الاجباري .")
return false
end
else
redis:set(siria..":UserNameChaneel",msg.text)
sendMsg(msg.chat_id_,msg.id_,"𖤓 جـيـد , الان لقد تم تفعيل الاشتراك الاجباري\n𖤓 على قناتك ⇜ ["..msg.text.."]")
return false
end
else
sendMsg(msg.chat_id_,msg.id_,"𖤓 عذرا , عزيزي المطور \n𖤓 هذا ليس معرف قناة , حاول مجددا .")
return false
end
end

if redis:get(siria..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(siria..'namebot:witting'..msg.sender_user_id_)
redis:set(siria..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"𖤓 تم تغير اسم البوت  .\n𖤓 الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(siria..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(siria..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(siria..'replay_photo:group:',msg.text)
redis:hdel(siria..'replay_voice:group:',msg.text)
redis:hdel(siria..'replay_animation:group:',msg.text)
redis:hdel(siria..'replay_audio:group:',msg.text)
redis:hdel(siria..'replay_sticker:group:',msg.text)
redis:hdel(siria..'replay_video:group:',msg.text)
redis:setex(siria..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"𖤓 جيد , يمكنك الان ارسال جوا ب الردالعام \n𖤓 [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(siria..'delrdall:'..msg.sender_user_id_) then
redis:del(siria..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(siria..'replay:all',msg.text)
local photo =redis:hget(siria..'replay_photo:group:',msg.text)
local voice = redis:hget(siria..'replay_voice:group:',msg.text)
local animation = redis:hget(siria..'replay_animation:group:',msg.text)
local audio = redis:hget(siria..'replay_audio:group:',msg.text)
local sticker = redis:hget(siria..'replay_sticker:group:',msg.text)
local video = redis:hget(siria..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(siria..'replay:all',msg.text)
redis:hdel(siria..'replay_photo:group:',msg.text)
redis:hdel(siria..'replay_voice:group:',msg.text)
redis:hdel(siria..'replay_audio:group:',msg.text)
redis:hdel(siria..'replay_animation:group:',msg.text)
...
if redis:get(siria..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(siria..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(siria..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "𖤓 ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(siria..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(siria..'welcom:witting'..msg.sender_user_id_) 
redis:set(siria..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"𖤓 ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(siria..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(siria..'rulse:witting'..msg.sender_user_id_) 
redis:set(siria..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** مرحبآ عزيزي\n𖤓 تم حفظ القوانين بنجاح .\n𖤓 ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(siria..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(siria..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(siria..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(siria..'linkGroup'..msg.sender_user_id_,link) 
redis:set(siria..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(siria..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(siria..'about:witting'..msg.sender_user_id_) 
tdcli_function({ID="ChangeChannelAbout",channel_id_=msg.chat_id_:gsub('-100',''),about_ = msg.text},function(arg,data) 
if data.ID == "Ok" then 
return sendMsg(msg.chat_id_,msg.id_,"𖤓 ** تم وضع الوصف بنجاح\n")
end 
end,nil)
end


if redis:get(siria..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(siria..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(siria..'users')  
local groups = redis:smembers(siria..'group:ids')
local allgp =  #pv + #groups
if allgp >= 300 then
sendMsg(msg.chat_id_,msg.id_,'𖤓 اهلا عزيزي المطور \n𖤓 جاري نشر التوجيه للمجموعات وللمشتركين ...')			
end
for i = 1, #pv do 
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 **تم اذاعه الكليشه بنجاح .\n𖤓 **للمجموعات » ( *'..#groups..'* )\n𖤓 ** للمشتركين » ( '..#pv..' )\n')
end

if redis:get(siria..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(siria..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(siria..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'𖤓 اهلا عزيزي المطور \n𖤓 جاري نشر الرساله للمجموعات ...')			
end
local NumGroupsDel = 0
for i = 1, #groups do 
sendMsg(groups[i],0,Flter_Markdown(msg.text),function(arg,data)
if data.chat_id_ then redis:setex(siria..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'𖤓 **عدد المجموعات { *'..#groups..'*  } ⊰•\n𖤓 **تـم الاذاعه بالتثبيت بنجاح ♥')
end

if redis:get(siria..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(siria..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(siria..'users')
if #pv >= 300 then
sendMsg(msg.chat_id_,msg.id_,'𖤓 اهلا عزيزي المطور \n𖤓 جاري نشر الرساله للمشتركين ...')			
end
local NumPvDel = 0
for i = 1, #pv do
sendMsg(pv[i],0,Flter_Markdown(msg.text),nil,function(arg,data)
...
if #pv == i then 
local SenderOk = #pv - NumPvDel
sendMsg(msg.chat_id_,msg.id_,'𖤓 **عدد المشتركين : ❴ '..#pv..' ❵\n𖤓 **تم الاذاعه الى ❴ '..SenderOk..'  ❵ مشترك \n') 
end
end)
end
end

if redis:get(siria..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(siria..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(siria..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'𖤓 اهلا عزيزي المطور \n𖤓 جاري نشر الرساله للمجموعات ...')			
end
...
MsgTDel = '𖤓 **تم حذف ❴ *'..NumGroupsDel..'* ❵ من قائمه الاذاعه لانهم قامو بطرد البوت من المجموعه'
else
MsgTDel = ''
end
sendMsg(msg.chat_id_,msg.id_,'𖤓 **عدد المجموعات ❴ *'..#groups..'* ❵\n𖤓 **تـم الاذاعه الى ❴ *'..AllGroupSend..'* ❵\n'..MsgTDel..'')
end
end)
end
end 
...
if msg.adduser and msg.adduser == our_id and redis:get(siria..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(siria..':WELCOME_BOT'),[[𖤓أهلاً انا بوت ]]..redis:get(siria..':NameBot:')..[[
𖤓 أختصاصي حماية‌‏ المجموعات
𖤓 مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(siria..'fwd:'..msg.sender_user_id_) then
redis:del(siria..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(siria..'users')
local groups = redis:smembers(siria..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 **تم اذاعه التوجيه بنجاح .\n𖤓 **للمجموعات » ❴ *'..#groups..'* ❵\n𖤓 **للخاص » ❴ '..#pv..' ❵\n')			
end

if msg.content_.ID == "MessagePhoto" and redis:get(siria..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(siria..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(siria..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'𖤓 تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(siria..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(siria..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
sendMsg(arg.chat_id_,arg.id_,'𖤓 ليس لدي صلاحيه تغيير الصوره \n𖤓 يجب اعطائي صلاحيه `تغيير معلومات المجموعه ` ⠀\n')
end
...
if redis:get(siria..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(siria..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(siria..'replay:'..msg.chat_id_,msg.text)
redis:hdel(siria..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(siria..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(siria..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(siria..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(siria..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(siria..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(siria..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"𖤓 جيد , يمكنك الان ارسال جواب الرد \n𖤓 [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(siria..'delrd:'..msg.sender_user_id_) then
redis:del(siria..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(siria..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(siria..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(siria..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(siria..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(siria..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(siria..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(siria..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(siria..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(siria..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(siria..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
function(arg,data)
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"𖤓 ** ًعذرا التثبيت مقفل من قبل الاداره تم ارجاع التثبيت القديم\n")
end
end,nil)
else
...
function(arg,data) 
if data.ID == "Ok" then
return sendMsg(msg.chat_id_,msg.id_,"𖤓 ** ًعذرا التثبيت مقفل من قبل الاداره تم الغاء التثبيت\n")      
end
end,nil)
end
return false
end
redis:set(siria..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(siria..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end

return sendMsg(msg.chat_id_,msg.id_,"𖤓 قام  ["..UserName.."]\n𖤓 بتغير اسم المجموعه .\n𖤓 الى "..Flter_Markdown(msg.content_.title_).." \n") 
end)
end
if msg.adduser or msg.joinuser then
if redis:get(siria..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(siria..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(siria..'welcome:msg'..msg.chat_id_) or "𖤓 اهلاً عزيزي {الاسم}\n𖤓 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n𖤓 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(siria..'rulse:msg'..msg.chat_id_) or "𖤓 مرحباً عزيري القوانين كلاتي .\n𖤓 ممنوع نشر الروابط\n𖤓 ممنوع التكلم او نشر صور اباحيه\n𖤓 ممنوع  اعاده توجيه\n𖤓 ممنوع التكلم بالسياسة\n𖤓 الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(siria..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(siria..'welcome:msg'..msg.chat_id_) or "𖤓 اهلن بك عزيزي {الاسم}\n𖤓 معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n𖤓 اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(siria..'rulse:msg'..msg.chat_id_) or "𖤓 مرحباً عزيري القوانين كلاتي .\n𖤓 ممنوع نشر الروابط\n𖤓 ممنوع التكلم او نشر صور اباحيه\n𖤓 ممنوع  اعاده توجيه\n𖤓 ممنوع التكلم بالسياسة\n𖤓 الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(siria..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(siria..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(siria..'welcome:get'..msg.chat_id_)
end
redis:setex(siria..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(siria..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(siria..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_siria = (redis:get(siria..'num_msg_siria'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_siria) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(siria..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"𖤓 العضو » "..USERNAME.."\n𖤓 قمـت بتكرار اكثر مـن "..NUM_MSG_siria.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(siria..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 صلاحياته منشئ القروب\n')   
end 
if Json_Info.result.status == "member" then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 مجرد عضو هنا\n')   
end 
if Json_Info.result.status == "administrator" then
if Json_Info.result.can_change_info == true then
info = 'ꪜ' else info = '✘' end
...
if Json_Info.result.can_promote_members == true then
promote = 'ꪜ' else promote = '✘' end
return sendMsg(chat,msg.id_,'𖤓 الرتبة : مشرف\n𖤓 والصلاحيات هي ↓ \nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n𖤓 تغير معلومات المجموعه ↞ ❪ '..info..' ❫\n𖤓 حذف الرسائل ↞ ❪ '..delete..' ❫\n𖤓 حظر المستخدمين ↞ ❪ '..restrict..' ❫\n𖤓 دعوة مستخدمين ↞ ❪ '..invite..' ❫\n𖤓 تثبيت الرسائل ↞ ❪ '..pin..' ❫\n𖤓 اضافة مشرفين جدد ↞ ❪ '..promote..' ❫\n\n𖤓 ملاحضه » علامة ❪  ꪜ ❫ تعني لديه الصلاحية وعلامة ❪ ✘ ❫ تعني ليس ليديه الصلاحيه')   
end
end
end

if msg.forward_info_ then
if redis:get(siria..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del Becuse Send Fwd \27[0m")

if data.ID == "Error" and data.code_ == 6 then 
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** لا يمكنني مسح الرساله المخالفه .\n𖤓 ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(siria..'lock_woring'..msg.chat_id_) and not redis:get(siria..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذراً ممنوع اعادة التوجيه  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) 
return redis:setex(siria..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(siria..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(siria..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** لا يمكنني مسح الرساله المخالفه .\n𖤓 ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذراً الانلاين مقفول  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
...
if utf8.len(msg.text) > 500 and redis:get(siria..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 ممنوع ارسال الكليشه والا سوف تجبرني على طردك  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
and redis:get(siria..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(siria..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 ممنوع ارسال الروابط  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(siria..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 ممنوع ارسال روابط الويب   \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(siria..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 ممنوع ارسال التاك  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(siria..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 ممنوع ارسال المعرف   \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) 
end,nil)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(siria..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 ممنوع ارسال الماركدوان  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(siria..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(siria..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذراً ممنوع التعديل تم المسح \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(siria..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الفيديو كام \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.photo then
if redis:get(siria..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الصور  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif redis:get(siria..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(siria..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الفيديو  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)   
end
...
return false
elseif redis:get(siria..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(siria..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** لا يمكنني مسح الرساله المخالفه .\n𖤓 ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
 ...
 if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الملفات  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.sticker and redis:get(siria..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الملصقات  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)   
end
...
return false
elseif msg.animation then
if redis:get(siria..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الصور المتحركه  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)   
end
...
return false
elseif redis:get(siria..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(siria..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** لا يمكنني مسح الرساله المخالفه .\n𖤓 ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
 ...
 if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال جهات الاتصال  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.location and redis:get(siria..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** لا يمكنني مسح الرساله المخالفه .\n𖤓 ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
 ...
 if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الموقع  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.voice and redis:get(siria..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return sendMsg(msg.chat_id_,msg.id_,'𖤓 ** لا يمكنني مسح الرساله المخالفه .\n𖤓 ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
 ...
 if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال البصمات  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)   
end
...
return false
elseif msg.game and redis:get(siria..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع لعب الالعاب  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.audio and redis:get(siria..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الصوت  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(siria..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا الكيبورد مقفول  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال الروابط  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
and redis:get(siria..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
local msgx = "𖤓 عذرا ممنوع ارسال روابط الويب  \n"
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
end
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(siria..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if redis:get(siria..'lock_woring'..msg.chat_id_) then
local msgx = "𖤓 عذرا ممنوع ارسال التاك او المعرف  \n"
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data.first_name_..' '..(data.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,data.id_,msg.id_,"𖤓 العضو » "..USERNAME..'\n'..msgx,12,USERCAR) end,nil)
...
if msg.text and redis:get(siria..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(siria..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(siria..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(siria..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(siria..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(siria..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(siria..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(siria..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(siria..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(siria..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(siria..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(siria..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(siria..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(siria..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(siria..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "سوريا" then return  sendMsg(msg.chat_id_,msg.id_,"[مبرمج سورس سوريا](https://t.me/SIRIA199)")
elseif Text== "عرابي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس سوريا](https://t.me/DEV_ORABI)")
elseif Text== "طيب" or Text== "طيب" then return  sendMsg(msg.chat_id_,msg.id_,"[شرير]")
elseif Text== "رفع غبي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم رفع الغبي بنجاح\n𖤓 تمت إضافته إلى قائمه الأغبياء\n☆")
elseif Text== "رفع خول"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقـد تم رفع الخول بنجاح\n𖤓الان هو خـول \n")
elseif Text== "تنزيل خول"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل الخول بنجاح \n𖤓 الان تم ازلته من قائمه الخولات \n")
elseif Text== "رفع بكس"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع الكس بنجاح\n𖤓الا𖤓الان هو في قائمه المكسكسين \n")
elseif Text== "تنزيل بكس"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل الكس بنجاح \n𖤓الان تم ازلته من قائمه المكسكسين \n")
elseif Text== "رفع متناك"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع المتناك بنجاح\n𖤓الان هو في قائمه المتناكين \n")
elseif Text== "تنزيل متناك"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل المتناك بنجاح \n𖤓الان تم ازلته من قائمه المتناكين \n")
elseif Text== "رفع عرص"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل عرص بنجاح\n𖤓الان تم ازلته من قائمه معرصين \n")
elseif Text== "تنزيل عرص"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل عرص بنجاح \n𖤓الان تم ازلته من قائمه معرصين \n")
elseif Text== "رفع شرموط"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع الشرموط بنجاح\n𖤓الان هو في قائمه الشراميط \n")
elseif Text== "تنزيل شرموط"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل الشرموط بنجاح \n𖤓الان تم ازلته من قائمه الشراميط \n")
elseif Text== "رفع شرموط"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع الشرموط بنجاح\n𖤓الان هو في قائمه الشراميط \n")
elseif Text== "رفع علق"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع العلق بنجاح\n𖤓الان هو في قائمه العلوق \n")
elseif Text== "تنزيل علق"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل العلق بنجاح \n𖤓الان تم ازلته من قائمه العلوق\n")
elseif Text== "رفع زبي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع الواد دا علي زبك بنجاح\n𖤓الان تستطيع ان تمرجحه \n")
elseif Text== "تنزيل زبي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل الواد دا من علي زبك بنجاح \n𖤓الان تم ازلته من فوق زبك\n")
elseif Text== "رفع شاذ"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع الشاذ بنجاح \n𖤓الان هو في قائمه الشواذ\n")
elseif Text== "تنزيل شاذ"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل شاذ بنجاح \n𖤓الان تم ازلته من قائمه الشواذ\n")
elseif Text== "رفع جوكر"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع عرابي بنجاح \n𖤓الان هو في قائمه الجواكر\n")
elseif Text== "تنزيل جوكر"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم تنزيل عرابي بنجاح \n𖤓الان تم ازلته من قائمه الجواكر\n")
elseif Text== "رفع بيست"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم رفع بيست بنجاح \n𖤓 الان هـ بيست يمكنك اخد مح\n")
elseif Text== "تنزيل بيست"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم تنزيل بيست \n𖤓 يمكن استرجاع المح الان\n")
elseif Text== "رفع حياتي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم رفع حياتي \n𖤓 الان هـ حياتك تفضل خد بوثه\n")
elseif Text== "تنزيل حياتي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم تنزيل من حياتي \n𖤓 الان يمكن استرجاع البوثه\n")
elseif Text== "رفع تونز"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم رفع تونز بنجاح \n𖤓 تفضل في الخاص عشان المراره\n")
elseif Text== "تنزيل تونز"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم تنزيل تونز بنجاح \n𖤓 الان يمكن عمل بلوك\n")
elseif Text== "رفع سندي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم رفع سندي بنجاح \n𖤓 الان هو سندك\n")
elseif Text== "تنزيل سندي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم تنزيل سندي \n𖤓 يمكن الان شقط سند اخر\n")
elseif Text== "رفع السوريا"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم رفع سوريا بنجاح \n𖤓 اديلو سوريا\n")
elseif Text== "تنزيل السوريا"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 لقد تم رفع سوريا بنجاح \n𖤓 اديلو سوريا\n")
elseif Text== "تنزيل غبي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\nلقد تم تنزيل الهاك\n𖤓 تمت الزاله من قائمه الأغبياء\n☆")
elseif Text== "رفع كلب"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم رفع الكلب بنجاح\n𖤓 تمت إضافته إلى قائمه الكلاب\n☆")
elseif Text== "رفع حمار"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم رفع الحمار بنجاح\n𖤓 تمت إضافته إلى قائمه الحمير\n☆")
elseif Text== "تنزيل حمار"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم تنزيل الحمار بنجاح\n𖤓 تمت ازالته من قائمه الحمير\n☆")
elseif Text== "تنزيل كلب"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي \n𖤓 تم تنزيل الكلب بنجاح\n𖤓 تمت إزالته من قائمه الكلاب\n☆")
elseif Text== "تنزيل متوحده"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم تنزيل المتوحده بنجاح\n𖤓 لا متحاولوش حتي لو نزلتوها هتفضل متوحده\n☆")
elseif Text== "رفع متوحده"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم رفع المتوحده بنجاح\n𖤓 تمت إضافتها الي قائمة المتوحدين والمتخلفين عقلياً\n☆")
elseif Text== "رفع متوحد"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم رفع المتوحد بنجاح\n𖤓 تمت  اضافته الي قائمة المتوحديد والمرضي المفسيين\n☆")
elseif Text== "تنزيل متوحد"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم تنزيل المتوحد بنجاح\n𖤓 لا متحاولوش حتي لو نزلتوه هيفضل متوحد\n☆")
elseif Text== "رفع بقلبي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم رفع العضو داخل قلبك\n𖤓 تمت ترقيته بنجاح\n☆")
elseif Text== "تنزيل من قلبي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم تنزيل من داخل قلبك\n𖤓 تمت ازالته من قائمه القلوب\n☆")
elseif Text== "رفع وتكه"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم رفع العضو وتكه بنجاح \n𖤓 اصبحت وتكتك\n☆")
elseif Text== "تنزيل وتكه"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم تنزيل العضو \n𖤓 من قائمة وتكاتك بنجاح\n☆")
elseif Text== "رفع زوجتي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم رفع العضو زوجتك\nالآن يمكنكم أخذ راحتكم واتفضلو اعملو واحد\n☆")
elseif Text== "تنزيل زوجتي"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم تنزيل زوجتك بنجاح\nالآن انتم مفترقان طلقتها علشان مبتعرفش صح\n☆")
elseif Text== "رفع سوريا"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم رفع الواد ضمن الزنوج بنجاح\n𖤓الان هو في قائمه القوقازيه \n")
elseif Text== "تنزيل سوريا"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 آههلآ  عـزيزي\n𖤓 تم ازاله الواد بعيدا عن الزنوج بنجاح \n𖤓الان تم ازلته من قائمه الزنوج\n")
elseif Text== "زواج"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم زواجكم الاثنين بنجاح\n𖤓 الآن هي حلالك بلالك\n☆")
elseif Text== "طلاق"  then return sendMsg(msg.chat_id_,msg.id_,"𖤓 أهلاً عزيزي\n𖤓 تم طلاق الخاينه بنجاح\n𖤓 الآن هي مطلقه \n☆")
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏≪━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐑𝐈𝐀 𖤓━━≫/n𖤓 مرحباً عزيزي\n𖤓 هذي اوامر التسليه:  \n┄─┅═ـ═┅─┄\n𖤓 رفع ≪━≫ تنزيل ❬ متوحد ❭\n𖤓 رفع ≪━≫ تنزيل ❬ وتكه ❭\n𖤓 رفع ≪━≫ تنزيل ❬ غبي ❭\n𖤓 رفع ≪━≫ تنزيل ❬ كلب ❭\n𖤓 رفع ≪━≫ تنزيل ❬ حمار ❭\n𖤓 رفع ≪━≫ تنزيل ❬ زوجتي ❭\n𖤓 رفع ≪━≫ تنزيل ❬ متوحده ❭\n𖤓 رفع ≪━≫ ❬ بقلبي ❭ تنزيل ≪━≫ ❬ من قلبي❭\n𖤓 ❬ طلاق ❭ ≪━≫ ❬ زواج ❭\n┄─┅═ـ═┅─┄")
elseif Text== "اوامر التسليه الجديده"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏≪━━𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐈𝐑𝐈𝐀 𖤓━━≫\n𖤓 مرحباً عزيزي\n𖤓 هذي اوامر التسليه:  \n┄─┅═ـ═┅─┄\nرفع ≪━≫ تنزيل ❬ خول ❭\n𖤓رفع ≪━≫ تنزيل ❬ عرص ❭\n𖤓رفع ≪━≫ تنزيل ❬ بكس ❭\n𖤓رفع ≪━≫ تنزيل ❬ متناك ❭\n𖤓رفع ≪━≫ تنزيل ❬ شرموط ❭\n𖤓رفع ≪━≫ تنزيل ❬ السوريا ❭\n𖤓رفع ≪━≫ تنزيل ❬ شاذ ❭\n𖤓رفع ≪━≫ تنزيل❬ بيست ❭\n𖤓رفع ≪━≫ تنزيل❬ تونز ❭\n𖤓رفع ≪━≫ تنزيل❬ علق ❭\n𖤓رفع ≪━≫ تنزيل❬ حياتي ❭\n𖤓رفع ≪━≫ تنزيل❬ سندي ❭\n𖤓رفع ≪━≫ تنزيل❬  \n┄─┅═ـ═┅─┄")
  ...
  return sendMsg(msg.chat_id_,msg.id_,[[
 𖤓 رابط حذف [Telegram](https://my.telegram.org/auth?to=delete) ܁
 𖤓 رابط حذف [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 𖤓 رابط حذف [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 𖤓 رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
‏
  ]] )
  --=====================================
elseif Text== "انا مين" or Text== "مين انا"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/SOURCE_SYRIA) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/SOURCE_SYRIA)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/SOURCE_SYRIA)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/SOURCE_SYRIA)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/SOURCE_SYRIA)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/SOURCE_SYRIA) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/SOURCE_SYRIA)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SOURCE_SYRIA)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SOURCE_SYRIA)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/SOURCE_SYRIA)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..siria..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(siria..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(siria..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(siria..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(siria..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(siria..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(siria..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(siria..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  Save_Data:close()
  sendDocument(SUDO_ID,0,"./inc/"..Bot_User..".json","𖤓 ملف نسخه تلقائيه\n𖤓   اليك مجموعاتك » { "..#All_Groups_ID.." }\n𖤓 للبوت » "..Bot_User.."\n𖤓 التاريخ » "..os.date("%Y/%m/%d").."\n",dl_cb,nil)
  end
  if redis:get(siria..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(siria..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'𖤓 انتهى الاشتراك في احد المجموعات .\n𖤓 المجموعه : '..FlterName(redis:get(siria..'group:name'..msg.chat_id_))..'.\n𖤓 ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'𖤓 انتهى الاشتراك البوت.\n𖤓 سوف اغادر المجموعه فرصه سعيده .\n𖤓 او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(siria..'ExpireDate:'..msg.chat_id_) / 86400)
  if tonumber(DaysEx) > 0.208 and ExpireDate ~= -1 and msg.Admin then
  if tonumber(DaysEx + 1) == 1 and not msg.SudoUser then
  sendMsg(msg.chat_id_,'𖤓 باقي يوم واحد وينتهي الاشتراك .\n𖤓 راسل المطور للتجديد '..SUDO_USER..'\n')
  end 
  end 
  end
  end
