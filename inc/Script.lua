...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/jack1eljoker1/siriafiles/main/GetVersion.txt' ) or 0
...
send_key(msg.sender_user_id_,'   [قناة سورس : بلاك](https://t.me/SOURCE_SYRIA)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "المبرمج جاك" and msg.type == "pv" then
local inline = {{{text="-مبرمج آلسـورس اضـغـط هـنـآ ",url="https://t.me/SIRIA199"}}}
send_key(msg.sender_user_id_,'   [مبرمج السورس جاك](https://t.me/SIRIA199)' ,nil,inline,msg.id_)
return false
end
...
{{text = '- 𓆩 ＤＥＶ ＯＲＡＢＩ᪥ 𓆪 .',url="https://t.me/DEV_ORABI"}},
{{text = '- 𓆩 ＤＥＶ ＡＢＮ ＡＬＳＡＨＥＬ𖤍᪥ 𓆪 .',url="https://t.me/@Xxman6xx"}},
{{text = '- 𓆩 ＳＩＲＩＡ𖤛 𓆪 .',url="https://t.me/SOURCE_SYRIA"}},
}   
send_inline(msg.chat_id_,  "𓆩 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒃𝒐𝒕   𓆪" ,keyboard,'html')
end
...
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
 ❍ ＳＯＵＲＳＥ ＳＩＲＩＡ †࿃ ❍
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ 𝐷𝐸𝑉 >> [˹ 𓆩 𝐃𝐄𝐕 S I R I A 𓆪 .](t.me/SIRIA199)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
]]
end
...
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
 ❍ ＳＯＵＲＳＥ ＳＩＲＩＡ †࿃ ❍
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
❍ 𝐷𝐸𝑉 >> [˹ 𓆩 ??𝐄𝐕 S I R I A 𓆪 .](t.me/SIRIA199)
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
ــــــــــــــــــــــ❍ـــــــــــــــــــــ
]]
end
...
function WelcomeByAddUser(siria,Diamond)
...
------set cmd------
siria = msg.text 
if siria == 'رفع مشرف كامل' and msg.reply_to_message_id_ ~= 0 then
...
if siria == 'رفع مشرف' and msg.reply_to_message_id_ ~= 0 then
...
if siria == 'تنزيل مشرف' and msg.reply_to_message_id_ ~= 0 then
...
if siria:match('تغير امر (.*)') then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = siria:match('تغير امر (.*)') 
...
if siria and (siria:match('^delcmd (.*)') or siria:match('^مسح امر (.*)')) then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = siria:match('^delcmd (.*)') or siria:match('^مسح امر (.*)')
redis:hdel(siria..'CmD:'..msg.chat_id_,cmd)
redis:srem(siria..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"❍ اهلا عزيزي\nالامر >"..cmd.."\n❍ تم مسحه من قائمه الاوامر\n")
end
if siria == 'مسح قائمه الاوامر' or siria == 'مسح قائمه الاوامر' then
if not msg.Kara then return "❍ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
...
if siria == 'welcome on' or siria == 'تفعيل الترحيب' then
if redis:get(siria..'welc'..msg.chat_id_) == 'on' then
...
if siria == 'welcome on' or siria == 'تفعيل البلاك تيم' then
if redis:get(siria..'welc'..msg.chat_id_) == 'on' then
...
elseif Text== "سوريا" or Text== "سوريا" then return  sendMsg(msg.chat_id_,msg.id_,"[اقمد من القمدان يبرو](https://t.me/SIRIA199)")
elseif Text== "ميرو" or Text== "ميرو" then return  sendMsg(msg.chat_id_,msg.id_,"[روح قلب سوريا ](https://t.me/UU_UqUIlj)")
...
elseif Text== "رفع بلاك"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ تم رفع الواد ضمن الزنوج بنجاح\n❍الان هو في قائمه القوقازيه \n")
elseif Text== "تنزيل بلاك"  then return sendMsg(msg.chat_id_,msg.id_,"❍ آههلآ  عـزيزي\n❍ تم ازاله الواد بعيدا عن الزنوج بنجاح \n❍الان تم ازلته من قائمه الزنوج\n")
...
elseif Text== "سورس" then return sendMsg(msg.chat_id_,msg.id_,"انتا ازاي مش عارف/nان انا علي افجر علي/nسورس مصري/n سورس سوريا/n")
