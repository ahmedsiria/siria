...
local inline = {{{text="-مبرمج آلسـورس اضـغـط هـنـآ ",url="https://t.me/siria22"}}}
...
local keyboard = {}
keyboard.inline_keyboard = {
{{text = '- 𝑫𝑬𝑽 𝑺𝑰𝑹𝑰𝑨 𖡛“ .',url="https://t.me/siria22"}},
...
send_inline(msg.chat_id_,  "𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐬𝐨𝐮𝐫𝐜𝐞 𝐬𝐲𝐫𝐢𝐚, 𝐭𝐡𝐞 𝐛𝐞𝐬𝐭 𝐬𝐨𝐮𝐫𝐜𝐞 𝐨𝐧 𝐭𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𖡨“" ,keyboard,'html')
end
...
if MsgText[1]== "سوريا" and msg.type == "pv" then
...
elseif Text== "احمد" then return  sendMsg(msg.chat_id_,msg.id_,"[𓆩 اقـــمــــد مــن الـــقــمــدان يـــآروحـــي 𓆪](https://t.me/siria22)")
