...
if redis:get(siria..'group:add'..msg.chat_id_) then  return '❍ **المجموعة تم تفعيلها مُسبقاً . ' end
...
elseif UserID == 1726705278 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر المبرمج سوريا\n") 
elseif UserID == 1465250253 then 
...
elseif UserID == 1726705278 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم المبرمج سوريا\n") 
elseif UserID == 1465250253 then 
...
elseif UserID == 1726705278 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المبرمج سوريا\n") 
elseif UserID == 1465250253 then 
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1726705278 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المبرمج سوريا\n") 
elseif UserID == 1465250253 then 
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1726705278 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المبرمج سورياn") 
elseif UserID == 1465250253 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور السورس\n") 
elseif UserID == 1877543059 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور السورس\n") 
...
if cmd == "dn_sudo" then
if not redis:sismember(siria..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'❍ **العضو » '..USERNAME..' \n❍ ** الايدي » (`'..UserID..'`)\n❍ **انه بالتأكيد ليس مطور \n') end
redis:srem(siria..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1726705278 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك المبرمج سوريا\n")  
elseif UserID == 1465250253 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور السورس\n") 
elseif UserID == 1877543059 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور السورس\n") 
...
.."\n❍ التعديل «» "..(redis:get(siria..'lock_edit'..msg.chat_id_) or 'false')
.."\n❍ الروابط «» "..(redis:get(siria..'lock_link'..msg.chat_id_) or 'false')
.."\n❍ التاك «» "..(redis:get(siria..'lock_tag'..msg.chat_id_) or 'false')
.."\n❍ المعرفات «» "..(redis:get(siria..'lock_username'..msg.chat_id_) or 'false')
.."\n❍ التكرار «» "..(redis:get(siria..'lock_flood'..msg.chat_id_) or 'false')
.."\n❍ الكلايش «» "..(redis:get(siria..'lock_spam'..msg.chat_id_) or 'false')
.."\n❍ الويب «» "..(redis:get(siria..'lock_webpage'..msg.chat_id_) or 'false')
.."\n❍ الماركدوان «» "..(redis:get(siria..'lock_markdown'..msg.chat_id_) or 'false')
.."\n❍ بالطرد البوتات «» "..(redis:get(siria..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n❍ البوتات «» "..(redis:get(siria..'lock_bots'..msg.chat_id_) or 'false')
.."\n❍ عدد التكرار «» "..(redis:get(siria..'num_msg_siria'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍`اعدادات الوسائط :`\n"
.."\n*❍ *المتحركه «» "..(redis:get(siria..'mute_gif'..msg.chat_id_) or 'false')
.."\n❍ الدردشه «» "..(redis:get(siria..'mute_text'..msg.chat_id_) or 'false')
.."\n❍ الانلاين «» "..(redis:get(siria..'mute_inline'..msg.chat_id_) or 'false')
.."\n❍ الالعاب «» "..(redis:get(siria..'mute_game'..msg.chat_id_) or 'false')
.."\n❍ الصور «» "..(redis:get(siria..'mute_photo'..msg.chat_id_) or 'false')
.."\n❍ الفيديو «» "..(redis:get(siria..'mute_video'..msg.chat_id_) or 'false')
.."\n❍ البصمات «» "..(redis:get(siria..'mute_audio'..msg.chat_id_) or 'false')
.."\n❍ الصوت «» "..(redis:get(siria..'mute_voice'..msg.chat_id_) or 'false')
.."\n❍ الملصقات «» "..(redis:get(siria..'mute_sticker'..msg.chat_id_) or 'false')
.."\n❍ الجهات «» "..(redis:get(siria..'mute_contact'..msg.chat_id_) or 'false')
.."\n❍ التوجيه «» "..(redis:get(siria..'mute_forward'..msg.chat_id_) or 'false')
.."\n❍ الموقع «» "..(redis:get(siria..'mute_location'..msg.chat_id_) or 'false')
.."\n❍ الملفات «» "..(redis:get(siria..'mute_document'..msg.chat_id_) or 'false')
.."\n❍ الاشعارات «» "..(redis:get(siria..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n❍ الكيبورد «» "..(redis:get(siria..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*`اعدادات اخرى : `"
.."\n\n*❍*الترحيب «» "..welcomex
.."\n*❍*الردود «» "..replayx
...
.."\n*❍*الويب «» "..(redis:get(siria..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*❍*الماركدوان «» "..(redis:get(siria..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*❍*البوتات بالطرد «» "..(redis:get(siria..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*❍*البوتات «» "..(redis:get(siria..'lock_bots'..msg.chat_id_) or 'false')
.."\n*❍*عدد التكرار «» "..(redis:get(siria..'num_msg_siria'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*اعدادات التقـييد :\n"
.."\n*❍*التقييد بالتوجيه «» "..(redis:get(siria..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالصور «» "..(redis:get(siria..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالروابط «» "..(redis:get(siria..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالمتحركه «» "..(redis:get(siria..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد الفيديو «» "..(redis:get(siria..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
